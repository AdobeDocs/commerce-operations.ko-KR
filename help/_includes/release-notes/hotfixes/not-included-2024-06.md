...
1. 2024년 7월 17일에 릴리스된 [핫픽스](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27136)를 적용합니다.

1. 암호화 키를 [회전](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/security/encryption-key)합니다.

옵션 2:

1. [격리된 패치](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27136)를 적용합니다.
