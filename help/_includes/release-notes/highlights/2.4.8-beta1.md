...
---
# 2024년 10월 Adobe Commerce 2.4.8-beta1 하이라이트
...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>Adobe Commerce은 이제 OpenSearch 2.x에 최적화되었으며 더 이상 Elasticsearch과 호환되지 않습니다. 모든 Elasticsearch 7 및 8 모듈과 클래스는 이제 코드 베이스에서 더 이상 사용되지 않습니다. Adobe은 지속적인 지원 및 호환성을 보장하기 위해 온-프레미스 및 클라우드 인프라 배포에 대해 OpenSearch로 전환할 것을 강력히 권장합니다. <a href="/help/upgrade/prepare/opensearch-migration.md">OpenSearch로 마이그레이션</a>을 참조하십시오.
              <ul>
...
이번 릴리스에는 다음과 같은 Braintree 번들 확장 개선 사항이 포함되어 있습니다.

<table style="table-layout:auto">
    <tbody>
        <tr>
            <td><strong>일반 개선 사항</strong></td>
            <td><!-- BUNDLE-3373 -->이제 Braintree 확장 기능에 PayPal 모달 내의 배송 방법이 포함되어 고객이 클릭 수를 줄여 체크아웃할 수 있으므로 진정한 의미의 빠른 결제 경험을 제공할 수 있습니다. 배송 옵션은 고객의 PayPal 계정에 저장된 배송 주소를 기반으로 나열되고 계산됩니다. 이전에는 고객이 검토 페이지에 도달하고 배송 방법을 선택하여 결제를 완료했습니다. 이제 검토 여정은 선택 사항이며 가맹점이 이 사용자 페이지를 활성화/비활성화할 수 있습니다. PayPal Express 버튼은 PDP, 미니 카트, 장바구니 및 체크아웃 상단에 있습니다.
            </td>
        </tr>
    </tbody>
</table>
