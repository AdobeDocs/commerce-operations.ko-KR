...
상태 기준 필터링(기본 활동 선택 시): in_progress, pending, complete 또는 cancelled. 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
완료되지 않은 활동만 포함합니다(기본 활동을 선택할 때). 이것은 의 축약이다 &lt;info>—state=in_progress,pending&lt;/info>
...
진행 중, 보류 중, 완료 또는 취소된 상태별로 활동을 필터링합니다. 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
유형의 모든 환경 삭제(선택한 다른 환경에 추가) 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
특정 유형의 환경만 삭제 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
환경 유형별로 목록을 필터링합니다. 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
유형별로 활동을 필터링합니다. 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
...
상태별로 활동을 필터링합니다. 목록이 단일 값(예: &quot;a,b,c&quot;)으로 주어지면 쉼표 및/또는 공백으로 분할됩니다.
