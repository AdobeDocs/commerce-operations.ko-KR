...
Google 쇼핑 광고 채널 및 Amazon Sales Channel과 같은 통합의 경우 Commerce 속성을 서드파티 속성에 매핑하여 제품, 디스플레이 광고를 올바르게 표시 및 판매합니다.
...
Commerce 애플리케이션을 관리하고 배포하도록 설계된 스크립트 및 도구 세트입니다. 이 패키지는 Docker 환경에 배포, Cron 관리, 프로젝트 구성 확인 및 Adobe 패치 적용 등 다양한 클라우드 인프라 프로세스의 Adobe Commerce을 간소화합니다.
