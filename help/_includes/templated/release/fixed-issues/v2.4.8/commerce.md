...
* _LYNX-420_: CartItemInterface의 is_available 특성이 매출 가능한 재고가 제품 수량보다 낮은 경우에도 true를 반환합니다.
   * _참고 사항 수정_: 판매 가능한 재고가 요청된 제품 수량보다 낮은 경우에도 CartItemInterface의 is_available 특성이 true를 잘못 반환하는 문제가 해결되었습니다. 이제 is_available 필드는 제품의 수량이 사용 가능한 재고량을 초과할 때 올바르게 false를 반환합니다.
...
* _LYNX-464_: 장바구니에서 구성 가능한 제품이 부족한 다른 제품을 제거하는 동안 GraphQL 오류가 발생했습니다.
   * _참고 사항 수정_: 장바구니에서 재고 있는 제품을 제거하려고 하면 장바구니에 재고가 부족한 구성 가능한 제품이 포함되어 있는 경우 &quot;요청한 수량을 사용할 수 없습니다&quot; GraphQL 오류가 발생하는 문제가 해결되었습니다. 이제 제거 가 오류를 트리거하지 않고 예상대로 작동합니다.
