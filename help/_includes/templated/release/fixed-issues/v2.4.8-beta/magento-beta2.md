...
---
# Magento Open Source 릴리스 노트(v2.4.8-beta2)

## v2.4.8-beta2의 특징

Magento Open Source 2.4.8 릴리스에는 다음 30개의 강조 표시가 적용됩니다.

### Braintree

* _BUNDLE-3400_: 지원되지 않는 LPM 제거
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3401_: Google 지급 표시
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3402_: Apple 지급 표시
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3403_: Google Pay Shipping 콜백
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3404_: 나중에 결제 메시지
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3405_: JS-SDK 단추
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3406_: Braintree 확장 내에서 코드 최적화
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3407_: Braintree PHP 및 JS SDK 업데이트
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3408_: 라인 항목(GooglePay)
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3409_: 라인 항목(Apple Pay)
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>
* _BUNDLE-3420_: 패키지 추적
   * _GitHub 코드 기여_: <https://github.com/magento/ext-braintree/pull/208>

### 프레임워크

* _AC-12012_: Nginx 버전을 1.24에서 1.26으로 업데이트
* _AC-12028_: 2.4.8 및 2.4.7용 최신 Composer 2.8 버전과 호환성을 추가합니다.
* _AC-12029_: Varnish 7.6과의 호환성 확인
* _AC-12970_: PHPUnit 10 업그레이드 파트 2 - 사용 중단 제거
   * _참고 사항 수정_: phpunit/phpunit 작성기 종속성을 호환 가능한 버전 &quot;phpunit/phpunit&quot;:&quot;10.x&quot;로 업데이트했습니다.
* _AC-13076_: 사용 가능한 최신 버전으로 모든 js 라이브러리 및 npm 종속성 업데이트
...
* _AC-13077_: 모든 번들 확장 및 통합 구성 요소가 PHP 8.4와 호환됩니다.
* _AC-13078_: 모든 Adobe Commerce 도구는 PHP 8.4와 호환됩니다.
* _AC-13079_: 모든 Adobe Commerce 프로젝트 laminas/dependencies가 PHP 8.4와 호환됩니다.
* _AC-13256_: TinyMCE 종속성을 버전 7에서 버전 6.8.5로 다운그레이드합니다.
* _AC-13276_: PHP 8.4 사용 중지를 사용하려면 Adobe Commerce 변경 내용이 필요합니다
* _AC-8828_: MySQL의 기본 데이터 정렬을 utf8mb4로 설정합니다.

### 기타

* _AC-12133_: Adobe Commerce 2.4.8 코어 코드가 PHP 8.4와 호환됩니다.
* _AC-12972_: 2.4.8-beta2 코어 품질 개선
* _AC-13038_: composer.json 및 모든 관련 지원에서 PHP 8.1 제거
...
* _AC-10982_: [2FA] Duo Web SDK과 통합하여 범용 프롬프트를 지원합니다.
   * _메모 수정_: TBD

### 테스트 프레임워크

* _AC-9037_: Adobe Commerce 소스 코드에 대해 Adobe 저작권을 사용하는 기능

### UI 프레임워크

* _AC-12944_: adobe commerce에서 TinyMCE 5 제거

## v2.4.8-beta2의 문제가 해결되었습니다.

Magento Open Source 2.4.8 코어 코드에서 159가지 문제를 해결했습니다. 이 릴리스에 포함된 해결된 문제의 하위 집합은 아래에 설명되어 있습니다.
