...
Adobe Commerce 2.4.8 코어 코드에서 279개의 문제를 해결했습니다. 이 릴리스에 포함된 해결된 문제의 하위 집합은 아래에 설명되어 있습니다.
...
* _AC-12268_:
   * _참고 사항 수정_: league/flysystem Composer 종속성을 최신 버전으로 업그레이드한 후 성능 문제를 조사합니다.
...
* _AC-12715_:
   * _참고 사항 수정_: 최신 버전으로 업그레이드되는 Laminas 작성기 종속성을 조사합니다.
