...
Adobe Commerce 2.4.8 코어 코드에서 253개 문제를 해결했습니다. 이 릴리스에 포함된 해결된 문제의 하위 집합은 아래에 설명되어 있습니다.
...
### 관리 UI, 업그레이드 - 호환성 업그레이드 도구

* _AC-12829_: Chrome 업그레이드 127에서 OTP 기능이 손상된 관리자 로그인
...
* _AC-12124_: [임의 버그] Fotorama 라이브러리가 로드되지 않음
...
* _AC-5969_: AlertProcessor - 인수 #2($storeId)은 int 형식이어야 합니다. 문자열을 지정해야 합니다.
   ...
   * _GitHub 코드 기여_: <https://github.com/magento/magento2/commit/0574ac23>
* _AC-12880_: 모든 번들 확장 일일 빌드 - 오류 보고서를 생성하지 않음
   * _참고 사항 수정_: 오류 없이 오류 보고서를 생성해야 합니다.
...
* _AC-12669_: 어설션 재생 중인 Vimeo/YouTube 비디오가 페이지 빌더 테스트에서 실패합니다
...
* _AC-11806_: SchemaBuilder.php의 줄: 253에서 Magento 오류를 업데이트할 수 없습니다.
   * _GitHub 문제_: <https://github.com/magento/magento2/issues/38592>
