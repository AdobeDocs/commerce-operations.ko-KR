...
[!DNL Commerce]이(가) 집중 주문 처리를 수행하는 동시에 상점 집중 판매가 발생하는 경우가 있을 수 있습니다. 해당 테이블에서 읽기 및 쓰기 작업 간의 충돌을 방지하기 위해 데이터베이스 수준에서 이 두 트래픽 패턴을 구분하도록 [!DNL Commerce]을(를) 구성할 수 있습니다. 주문 데이터를 비동기식으로 저장하고 인덱싱할 수 있습니다. 주문이 임시 저장소에 보관되고 충돌 없이 Order Management 그리드로 대량으로 이동됩니다. 이 옵션은 **[!UICONTROL Stores]> [!UICONTROL Settings] > [!UICONTROL Configuration] > [!UICONTROL Advanced] > [!UICONTROL Developer] > [!UICONTROL Grid Settings] >[!UICONTROL Asynchronous indexing]**&#x200B;에서 활성화할 수 있습니다. 자세한 내용은 _관리 사용 안내서_&#x200B;의 [예약된 격자 업데이트](https://docs.magento.com/user-guide/sales/order-grid-updates-schedule.html)를 참조하십시오.

>[!WARNING]
>
>**[!UICONTROL Developer]** 탭과 옵션은 [개발자 모드](../configuration/cli/set-mode.md)에서만 사용할 수 있습니다. [클라우드 인프라의 Adobe Commerce](https://devdocs.magento.com/cloud/requirements/cloud-requirements.html#cloud-req-test)은(는) `Developer` 모드를 지원하지 않습니다.
...
>[!INFO]
>
>**[!UICONTROL Developer]** 탭과 옵션은 [개발자 모드](../configuration/cli/set-mode.md)에서만 사용할 수 있습니다. [Adobe [!DNL Commerce] 클라우드 인프라](https://devdocs.magento.com/cloud/requirements/cloud-requirements.html#cloud-req-test)에서 `Developer` 모드를 지원하지 않습니다.
...
[고객 세그먼트](https://docs.magento.com/user-guide/marketing/customer-segments.html)가 많은 가맹점은 고객 로그인 및 장바구니에 제품 추가와 같은 고객 작업에 대해 상당한 성능 저하를 경험할 수 있습니다.
