...
>[!WARNING]
>
>**[!UICONTROL Developer]** 탭과 옵션은 [개발자 모드](../configuration/cli/set-mode.md)에서만 사용할 수 있습니다. [클라우드 인프라의 Adobe Commerce](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/overview#cloud-req-test)은(는) `Developer` 모드를 지원하지 않습니다.
