...
**장바구니 로드 시 인벤토리 검사 사용**&#x200B;은(는) 기본적으로 사용(예로 설정)됩니다. 장바구니를 로드할 때 인벤토리 검사를 비활성화하려면 관리 UI **[!UICONTROL Enable Inventory Check On Cart Load]**&#x200B;스토어`No` > **구성** > **카탈로그** > **인벤토리** > **재고 옵션** 섹션에서 **을(를)**(으)로 설정하십시오. [사용 안내서](https://experienceleague.adobe.com/en/docs/commerce-admin/inventory/configuration/global-options)에서 [전역 옵션 구성](https://experienceleague.adobe.com/en/docs/commerce-admin/inventory/guide-overview) 및 _카탈로그 인벤토리_&#x200B;를 참조하십시오.
