...
[!DNL Upgrade Compatibility Tool]에 대한 자세한 내용은 이 [비디오 튜토리얼](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/upgrade-compatibility-tool-overview)&#x200B;(06:02)을 참조하세요.
...
자세한 내용은 [바닐라 인스턴스 배포](https://developer.adobe.com/commerce/contributor/guides/install/) 항목을 참조하십시오.
