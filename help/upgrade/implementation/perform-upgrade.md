...
>[!NOTE]
>
>- 클라우드 인프라 프로젝트의 Adobe Commerce에 대해서는 Cloud Guide에서 [Commerce 버전 업그레이드](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/upgrade/commerce-version)를 참조하십시오.
