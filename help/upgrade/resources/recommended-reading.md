---
title: 업그레이드 시 권장 읽기
description: Adobe Commerce 업그레이드 계획에 대한 권장 읽기 검토.
    ...
    <tr>
      <td><strong>릴리스 노트 및 공지</strong>
        <p>제품 전략, 보안, 버그 수정 및 알려진 문제 등 Adobe Commerce 및 Magento Open Source의 최신 개발에 대해 알아봅니다.</p>
          <ul>
            ...
            <li><a href="https://experienceleague.adobe.com/docs/commerce-operations/release/notes/overview.html">릴리스 노트</a></li>
      ...
      <td><strong>도구</strong>
        <p>Adobe Commerce 및 Magento Open Source 소프트웨어를 보다 쉽게 찾고 사용할 수 있도록 디자인된 찾아보기 도구입니다.</p>
          <ul>
            <li><a href="https://experienceleague.adobe.com/docs/commerce-learn/tutorials/uct-phpstorm.html">Upgrade Compatibility Tool PhpStorm 플러그인</a> (비디오)</li>
      ...
      <td><strong>업그레이드 리소스</strong>
        <p>저장소 보안을 유지하고 효율적으로 운영할 수 있습니다. Adobe의 광범위한 기술 문서를 검토하여 Adobe Commerce 또는 Magento Open Source 업그레이드를 준비하십시오.</p>
          <ul>
            ...
            <li><a href="https://developer.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/">호환되지 않는 이전 변경 사항</a></li>
