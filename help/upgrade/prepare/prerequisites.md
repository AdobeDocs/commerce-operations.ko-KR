...
사용자 환경에서 모든 시스템 요구 사항 및 종속성을 업데이트했는지 확인합니다. 대상 PHP 버전 및 [필수 PHP 설정](../../installation/prerequisites/php-settings.md#php-settings)에 대한 [PHP 마이그레이션 부록](https://www.php.net/manual/en/appendices.php)을 검토하십시오.
