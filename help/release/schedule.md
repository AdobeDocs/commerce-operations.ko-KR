...
<tfoot>
   <tr>
      <td colspan="3"><strong>범례</strong>
         <ul>
           <li><strong><img alt="B2B 기능 아이콘" src="../assets/icons/enterprise.svg"></img> B2B</strong>—Adobe Commerce용 B2B 확장의 새로운 기능, 개선 사항 및 버그 수정 사항. B2B 확장 릴리스에 대한 자세한 내용은 <a href="https://experienceleague.adobe.com/docs/commerce-admin/b2b/release-notes.html">B2B 릴리스 노트</a>.</li>
