...
1. 클라우드에서 안전하고 지원되는 Adobe Commerce 버전입니다. 완전히 지원되는 버전에는 2.4.8, 2.4.9 또는 사용 가능한 최신 릴리스가 포함됩니다. [여기](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy)에서 주기 정책을 확인하세요.
...
1. [클라우드 콘솔](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/start/cloud-console)에 로그인합니다. Cloud Console에서 모든 환경을 볼 수 있습니다.
...
4. [서비스 구성](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/service/services-yaml)의 지침을 사용하여 각 환경이 실행 중인 종속성 버전을 확인하세요.
