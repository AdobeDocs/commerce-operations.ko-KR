...
1. [클라우드 콘솔](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/start/cloud-console)에 로그인합니다.
...
자세한 지침은 [서비스 구성](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/service/services-yaml)을 참조하세요.
...
1. 관리 패널에서 버전을 숨기는 경우:
   ...
   * [원격 환경](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/secure-connections#connect-to-a-remote-environment)에 연결합니다.
...
* **데이터 마이그레이션:** [대량 및 증분 데이터 마이그레이션 도구](https://experienceleague.adobe.com/en/docs/commerce/cloud-service/migration/migration-tools/bulk-data/migration-tool)가 데이터를 새 [!DNL Adobe Commerce as a Cloud Service] 환경으로 이동합니다.
