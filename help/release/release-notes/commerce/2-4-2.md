...
* 의 성능 문제 `module-catalog-import-export/Model/Import/Product/Option.php` 해결되었습니다. 10만 개 이상의 레코드를 내보내거나 가져오는 데 필요한 시간이 단축되었습니다. 다음을 참조하십시오. [제품 옵션이 많아 가져오기/내보내기가 예상보다 오래 걸립니다](https://support.magento.com/hc/en-us/articles/360050695772) 기술 자료 문서입니다.
