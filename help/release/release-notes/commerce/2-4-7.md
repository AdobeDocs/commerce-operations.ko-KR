...
* FedEx와 Adobe Commerce [통합](https://experienceleague.adobe.com/ko/docs/commerce-admin/stores-sales/delivery/shipping-carriers/fedex)이(가) 레거시 FedEx WSDL 웹 서비스에서 최신 FedEx RESTful API로 마이그레이션되었습니다. FedEx 웹 서비스 추적, 주소 유효성 검사 및 우편 번호 유효성 검사 WSDLS는 2024년 5월에 중단됩니다. <!-- AC-1470 -->
...
[작성기](https://experienceleague.adobe.com/docs/commerce-operations/installation-guide/composer.html?lang=ko)를 사용하여 Adobe Commerce 2.4.7을 설치할 수 있습니다.
