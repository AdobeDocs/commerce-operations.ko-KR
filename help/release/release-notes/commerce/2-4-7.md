...
* **에 대한[!DNL Google Pay]** 3DS 지원 - 토큰화되지 않은 [!DNL Google Pay]개의 카드에 대해 3DS 확인 지원이 포함되었습니다. 자세한 내용은 [Braintree 설명서](https://developer.paypal.com/braintree/docs/guides/3d-secure/client-side/android/v3#using-3d-secure-with-google-pay)를 참조하세요.
