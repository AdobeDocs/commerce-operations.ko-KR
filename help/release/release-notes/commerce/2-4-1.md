...
* 이제 Composer를 사용하여 Adobe Commerce을 설치한 후 `bin/magento sampledata:deploy`을(를) 사용하여 샘플 데이터를 예상대로 배포할 수 있습니다. 이전에는 응용 프로그램에서 다음 오류가 발생했습니다. `Git installations must deploy sample data from GitHub; see https://experienceleague.adobe.com/ko/docs/commerce-operations/installation-guide/next-steps/sample-data/git-repositories for more information`. _가져오기 요청 [27481](https://github.com/magento/magento2/pull/27481)_&#x200B;에서 Andrii Beziazychnyi가 제출한 수정 사항입니다. [GitHub-19481](https://github.com/magento/magento2/issues/19481)
