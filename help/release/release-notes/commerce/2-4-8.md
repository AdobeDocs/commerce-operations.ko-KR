...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>혼동을 최소화하기 위해 [!UICONTROL Submit Comment]주문 세부 정보[!UICONTROL Update] 페이지에서 <a href="https://experienceleague.adobe.com/ko/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order"> 단추 레이블이 </a>(으)로 변경되었습니다.</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
           ...
           <td>이번 릴리스에는 다음과 같은 사용자 주문 관리 개선 사항이 포함됩니다.
             <ul>
              ...
              <li><!--LYNX-642-->상인이 <code>order.availableActions</code>관리자에서 순서 변경 기능을 사용하지 않도록 설정<code>REORDER</code>하는 경우 <a href="https://experienceleague.adobe.com/ko/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders"> 작업이 반환되지 않도록 </a> 필드를 업데이트했습니다.</li>
