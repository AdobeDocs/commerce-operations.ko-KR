...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>혼동을 최소화하기 위해 [!UICONTROL Submit Comment]주문 세부 정보[!UICONTROL Update] 페이지에서 <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order"> 단추 레이블이 </a>(으)로 변경되었습니다.</td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-377--><code>not_available_message</code>에 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CartItemInterface"><code>CartItemInterface</code></a>을(를) 추가했습니다.</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>이번 릴리스에는 다음과 같은 고객 관리 개선 사항이 포함됩니다.
             <ul>
               ...
               <li><!--LYNX-566-->고객 주소에 대한 페이지 매김을 추가하여 <code>customer.addressesV2</code> 쿼리에 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/customer/"><code>customer</code></a> 필드를 추가했습니다.</li>
             </ul>
           </td>
        </tr>
        <tr>
           ...
           <td>이번 릴리스에는 다음과 같은 사용자 주문 관리 개선 사항이 포함됩니다.
             <ul>
              ...
              <li><!--LYNX-470--><code>date_of_first_order</code> 형식에 새 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrders"><code>CustomerOrders</code></a> 필드를 추가했습니다.</li>
              ...
              <li><!--LYNX-449-->가격에 대한 새 필드가 여러 개 있는 <code>OrderItemPrices</code>에 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CartItemPrices"><code>CartItemPrices</code></a>과(와) 유사한 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-OrderItemInterface"><code>OrderItemInterface</code></a> 형식을 추가했습니다.</li>
              <li><!--LYNX-448-->이메일 일치를 기반으로 게스트 주문을 고객 계정과 병합하는 API 기능이 개선되었습니다. 재방문 고객을 위한 주문 관리를 간소화합니다.</li>
              <li><!-- LYNX-523: -->더 나은 주문 관리를 위해 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrder"><code>CustomerOrder</code></a> 필드를 포함하도록 <code>available_actions</code> 형식을 확장했습니다. 'available_actions' 필드는 해당 주문에서 수행할 수 있는 작업을 나열하는 열거형에 매핑됩니다.</li>
              <li><!-- LYNX-524 --><code>customer_info</code> 형식에 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrder"><code>CustomerOrder</code></a> 필드를 추가했습니다. 이 필드에는 고객 이름에 대한 세부 정보가 포함된 <code>OrderCustomerInfo</code> 형식이 필요합니다.</li>
              ...
              <li><!--LYNX-642-->상인이 <code>order.availableActions</code>관리자에서 순서 변경 기능을 사용하지 않도록 설정<code>REORDER</code>하는 경우 <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders"> 작업이 반환되지 않도록 </a> 필드를 업데이트했습니다.</li>
              <li><!--LYNX-598-->일부 국가에서는 우편 번호를 선택 사항으로 간주하므로 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order/"><code>guestOrder</code></a> 대신 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token/"><code>guestOrderByToken</code></a>을(를) 사용하도록 <code>lastname</code> 및 <code>postcode</code> 쿼리를 업데이트했습니다. 그 결과 일부 게스트 사용자는 주문 배치 중에 토큰을 가져오거나 토큰을 사용하여 주문된 항목을 검색하는 동안 문제가 발생했습니다.</li>
              ...
              <li><!--LYNX-524--><code>OrderCustomerInfo</code> 형식에 <code>CustomerOrder</code>을(를) 추가했습니다.</li>
              ...
              <li><!--LYNX-470--><code>created_at</code> 필드를 기반으로 주문 내역 필터를 추가하고 <code>date_of_first_order</code> 유형의 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrders"><code>CustomerOrders</code></a>을(를) 노출했습니다.</li>
              <li><!--LYNX-450--><code>is_virtual</code> 형식과 유사한 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrder"><code>CustomerOrder</code></a> 필드를 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-Cart"><code>Cart</code></a> 형식에 추가했습니다. 이를 통해 고객은 가상 제품만 포함된 주문에 대한 배송 정보를 조건부로 숨길 수 있습니다.</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->재고 수준 세부 정보를 제공하기 위해 <code>quantity</code>에 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-ProductInterface"><code>ProductInterface</code></a> 필드를 추가했습니다. 관리자 설정에 따라 사용 가능한 재고 또는 null이 표시됩니다.</li>
              <li><!--LYNX-460-->번들 제품에 대한 가격 표시가 수정되어 정확한 가격 및 통화 정보가 보장됩니다.</li>
              <li><!--LYNX-401--><code>grouped_product_image</code> 형식에 <code>configurable_product_image</code> 및 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-StoreConfig"><code>StoreConfig</code></a> 필드를 추가했습니다.</li>
            </ul>
        </td>
    </tr>
    <tr>
        ...
        <td>
            <ul>
              <li><!--LYNX-713-->선물 포장(항목 및 주문당) 및 인쇄된 카드에 대해 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-GiftOptionsPrices"><code>GiftOptionsPrices</code></a> 및 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-OrderTotal"><code>OrderTotal</code></a> 필드를 모두 포함하도록 <code>price_excluding_tax</code> 및 <code>price_including_tax</code> 형식을 업데이트했습니다. 이러한 향상된 기능을 통해 장바구니 및 주문 쿼리 모두에 대한 스토어 구성 설정을 기반으로 정확한 세금 표시가 가능합니다.</li>
              <li><!--LYNX-695-->문자열 대신 가격 개체를 반환하도록 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/store-config/"><code>storeConfig</code></a>을(를) 포함하도록 <code>printed_card_priceV2</code> 쿼리를 업데이트했습니다.</li>
              <li><!--LYNX-694--><code>gift_wrapping_available</code> 쿼리에 <code>gift_wrapping_price</code> 및 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/products/"><code>products</code></a> 필드를 추가했습니다. 이제 <code>gift_wrapping_price</code> 필드가 가격 개체로 반환됩니다.</li>
              <li><!--LYNX-693--><code>gift_message</code> 형식에 <code>gift_wrapping</code> 및 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-GiftCardItem"><code>GiftCardCartItem</code></a> 필드를 추가했습니다. 가상 제품에 대한 선물 포장을 삭제하도록 논리를 업데이트했습니다.</li>
              <li><!--LYNX-692--><a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/orders/"><code>customerOrders</code></a> 필드를 올바르게 처리하기 위해 <code>gift_message</code> 쿼리를 업데이트했습니다.</li>
              <li><!--LYNX-691--><a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/orders/"><code>customerOrders</code></a>과(와) 유사한 적용된 기프트 카드 데이터를 검색할 수 있도록 <code>applied_gift_cards</code> 필드를 포함하도록 <code>applied_coupons</code> 쿼리를 업데이트했습니다.</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <ul>
                ...
                <li><!--LYNX-697--><code>subtotal_excl_tax</code> 형식에 <code>subtotal_incl_tax</code> 및 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-OrderTotal"><code>OrderTotal</code></a> 필드를 추가했습니다. <code>subtotal</code> 필드를 더 이상 사용되지 않는 것으로 표시했습니다.</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-522--><code>theme</code> 쿼리에 <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#query-recaptchaV3Config"><code>recaptchaV3Config</code></a> 필드를 추가했습니다. 이 필드에서는 정확한 가격 및 통화 정보를 보장하기 위해 reCaptcha 렌더링에 사용할 테마의 이름을 지정할 수 있습니다.</li>
