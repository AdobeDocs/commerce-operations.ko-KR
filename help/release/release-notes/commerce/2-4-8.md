    ...
    <tbody>
        <tr>
            ...
            <td>이번 릴리스에는 다음과 같은 보안 설정 개선 사항이 포함됩니다.
              <ul>
                <li><strong>Duo Security 2FA</strong>: 이 변경 사항은 최신 SDK(Web SDK v4)를 사용하도록 Adobe Commerce의 <a href="https://experienceleague.adobe.com/ko/docs/commerce-admin/systems/security/tfa/security-two-factor-authentication-use#duo-security">Duo Security</a> 2단계 인증(2FA) 구현을 업데이트합니다. 이 업그레이드를 통해 판매자는 Duo Universal Prompt 사용으로 원활하게 전환할 수 있습니다. 판매자는 클라이언트 ID 및 암호를 포함하도록 관리 설정에서 구성을 업데이트해야 합니다.<!-- AC-10982 --></li>
