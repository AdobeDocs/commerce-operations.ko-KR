    ...
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-731-->장바구니 규칙 정보를 검색하기 위한 GraphQL 지원이 추가되었습니다. 활성 장바구니 규칙을 가져오기 위한 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/cart/queries/all-rules/"><code>allCartRules</code></a> 쿼리 및 <code>Cart.rules</code> 필드와 함께 모든 장바구니 규칙의 노출을 제어하는 새 저장소 구성을 도입했습니다.</li>
            </ul>
        </td>
       </tr>
        <tr>
           ...
           <td>이번 릴리스에는 다음과 같은 고객 관리 개선 사항이 포함됩니다.
             <ul>
               ...
               <li><!--LYNX-773-->개인화 기능을 사용하도록 설정하는 새 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/segments/"><code>customerSegments</code></a> 쿼리를 추가했습니다.</li>
               <li><!--LYNX-729-->게스트 및 고객에 대한 고객 그룹 관련 정보를 반환하기 위해 <code>customerGroup</code> 쿼리를 추가했습니다.</li>
               <li><!--LYNX-732-->고객 그룹 관리를 위한 새 스토어 구성을 추가하고, 사용 가능한 모든 고객 그룹 목록을 검색하기 위해 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/all-groups/"><code>allCustomerGroups</code></a> 쿼리를 도입했으며, 현재 로그인한 고객의 그룹 정보에 액세스할 수 있도록 <code>Customer.group</code> 필드를 노출했습니다.</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-730-->카탈로그 가격 책정 규칙에 대한 저장소 구성을 추가하고, 사용 가능한 모든 카탈로그 규칙을 검색하기 위해 <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/products/queries/all-rules/"><code>allCatalogRules</code></a> 쿼리를 추가했으며, 현재 제품에 적용된 카탈로그 규칙을 표시하기 위해 <code>Product.rules</code> 필드를 노출했습니다.</li>
