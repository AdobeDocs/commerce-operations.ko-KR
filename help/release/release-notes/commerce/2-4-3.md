...
[Adobe Sensei](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview)에서 제공하는 [실시간 검색](https://www.adobe.com/sensei.html)은(는) 인공 지능과 머신 러닝 알고리즘을 사용하여 집계된 방문자 데이터를 심층 분석함으로써 직관적인 검색 경험을 제공합니다. [실시간 검색 릴리스 정보](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html)를 참조하세요.
