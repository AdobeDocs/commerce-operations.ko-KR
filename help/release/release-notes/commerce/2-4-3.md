...
* **희망 목록**. [addWishlistItemsToCart 돌연변이](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-wishlist-items-to-cart.html)이(가) 지정된 위시리스트에서 고객의 장바구니로 항목을 이동합니다. <!-- magento/partners-magento2ee#449-->

* **선물 등록**. 포함된 작업: <!-- PWA-1290-->

   * [giftRegistry 쿼리](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry.html)를 사용하여 고객의 선물 등록 내용을 반환합니다.

   * [유형](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-type-search.html), [이메일](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-email-search.html) 또는 [ID](https://devdocs.magento.com/guides/v2.4/graphql/queries/gift-registry-id-search.html)별로 선물 등록기를 검색합니다.

   * [선물 등록기를 만들기](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-gift-registry.html), [업데이트](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry.html) 또는 [삭제](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry.html)합니다.

   * 선물 레지스트리에서 항목을 [업데이트](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-items.html) 또는 [제거](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-items.html)합니다.

   * [모든 항목을 장바구니에서 선물 등록으로 이동](https://devdocs.magento.com/guides/v2.4/graphql/mutations/move-cart-items-to-gift-registry.html)합니다. <!-- ENGCOM-9082 9087-->

   * 선물 레지스트리에서 등록자를 [추가](https://devdocs.magento.com/guides/v2.4/graphql/mutations/add-gift-registry-registrants.html), [업데이트](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-gift-registry-registrants.html) 또는 [제거](https://devdocs.magento.com/guides/v2.4/graphql/mutations/remove-gift-registry-registrants.html)합니다.

   * 초대받은 사람과 선물 레지스트리를 [공유](https://devdocs.magento.com/guides/v2.4/graphql/mutations/share-gift-registry.html)합니다.

* **협상 가능한 견적**. [`negotiableQuote`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quote.html) 및 [`negotiableQuotes`](https://devdocs.magento.com/guides/v2.4/graphql/queries/negotiable-quotes.html) 쿼리를 참조하세요. <!-- PWA-1292-->
...
* **공유된 경로**. [라우팅 쿼리](https://devdocs.magento.com/guides/v2.4/graphql/queries/route.html) 및 [RoutableInterface](https://devdocs.magento.com/guides/v2.4/graphql/interfaces/routable-interface.html)는 제품, 범주 및 CMS 페이지에서 라우팅 요청을 지원합니다. `urlResolver` 쿼리는 더 이상 사용되지 않으며 해당 기능은 `route` 쿼리로 대체되었습니다.
...
* Google Analytics이 활성화되면 관리자가 상점 첫 화면에서 페이지를 로드하려고 할 때 애플리케이션에서 더 이상 오류가 발생하지 않습니다. AJAX 요청 to www.google-analytics.com을 허용하도록 `connect-src`에 대한 CSP 항목이 추가되었습니다. [GitHub-30880](https://github.com/magento/magento2/issues/30880)
...
* [`dynamicBlocks` 쿼리](https://devdocs.magento.com/guides/v2.4/graphql/queries/dynamic-blocks.html)이(가) 지정된 필터와 일치하는 동적 블록의 내용을 반환합니다.
...
* 관리 양식을 렌더링하기 위해 하나의 편집 페이지만 필요한 경우 응용 프로그램에서 더 이상 모든 CMS 페이지를 로드하지 않습니다.  이제 이러한 페이지가 더 빨리 로드됩니다. [GitHub-30936](https://github.com/magento/magento2/issues/30936)
...
* `customer/create_account/vat_frontend_visibility`을(를) 사용하도록 설정하면 응용 프로그램에서 고객 등록 페이지에 **VAT 번호** 필드를 표시합니다. [GitHub-31326](https://github.com/magento/magento2/issues/31326)
...
**문제**: GraphQL `category` 및 `categoryList` 쿼리는 공유 카탈로그의 범주를 숨기거나 노출할지 여부를 결정하는 범주 권한을 무시합니다. 현재 상점에는 공유 카탈로그에 할당되거나 할당 해제된 모든 카테고리가 표시됩니다. 이 문제는 B2B 공유 카탈로그가 활성화된 PWA 저장소를 구현하는 Adobe Commerce 2.4.3 배포에 영향을 줍니다. <!-- MC-42528-->
