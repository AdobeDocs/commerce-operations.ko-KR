---
title: Adobe Commerce 2.4.4-p6 릴리스 노트
description: 2.4.4-p6 Adobe Commerce 릴리스의 보안 문제에 대한 수정 사항에 대해 알아봅니다.
...
# Adobe Commerce 2.4.4-p6 릴리스 노트

Adobe Commerce 2.4.4-p6은 Adobe Commerce 2.4.4 또는 Magento Open Source 2.4.4 배포를 개선하는 10가지 보안 수정 사항을 제공하는 보안 릴리스입니다. 이전 릴리스에서 식별된 취약점에 대한 수정 사항을 제공합니다.
