...
* `PHPStan` (제약 조건이있는 ^ 1.5.7) [GitHub-35315](https://github.com/magento/magento2/issues/35315)<!-- AC-2876-->

DHL 통합 스키마가 v6.0에서 v6.2로 업데이트되었습니다. 이 업그레이드로 인해 제품 동작이 변경되지는 않습니다.  <!-- AC-3022-->
