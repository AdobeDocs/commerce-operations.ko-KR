...
* **선물 옵션**. 모든 고객 및 게스트는 주문에 선물 메시지를 추가할 수 있습니다. 고객은 주문에 선물 포장, 선물 영수증, 인쇄 카드를 추가할 수도 있습니다. [`setGiftOptionsOnCart` 돌연변이](https://devdocs.magento.com/guides/v2.4/graphql/mutations/set-gift-options.html) 및 [`updateCartItems` 돌연변이](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-cart-items.html)<!-- MC-32345--> 참조
...
* 쇼핑객은 체크아웃 중에 선물 메시지 옵션을 선택할 수 있습니다. 이제 GraphQL에서 다양한 유형의 장바구니 항목에 대한 선물 메시지 옵션을 다룹니다. [`setGiftOptionsOnCart` 돌연변이](https://devdocs.magento.com/guides/v2.4/graphql/mutations/set-gift-options.html) 및 [`updateCartItems` 돌연변이](https://devdocs.magento.com/guides/v2.4/graphql/mutations/update-cart-items.html)을(를) 참조하십시오. 끌어오기 요청 [28519](https://github.com/magento/magento2/pull/28105), [27956](https://github.com/magento/magento2/pull/27956), [28072](https://github.com/magento/magento2/pull/28072), [28072](https://github.com/magento/magento2/pull/28072)에서 Oleh Usik가 제출한 수정 사항(_Fix). [GitHub-28519](https://github.com/magento/magento2/issues/28519)
...
* [Klarna의 결제 방법](https://devdocs.magento.com/guides/v2.4/graphql/payment-methods/klarna.html) 및[`createKlarnaPaymentsSession`](https://devdocs.magento.com/guides/v2.4/graphql/mutations/create-klarna-payments-session.html)에서 Klarna GraphQL에 대한 주제를 추가하거나 업데이트했습니다.
...
* 견본 계층 탐색 필터는 이제 Magento Open Source 전체에서 사용되는 표준 필터와 일치합니다. _끌어오기 요청 [28015](https://github.com/magento/magento2/pull/28015)_&#x200B;에서 Bartłomiej Szubert가 제출한 수정 사항입니다. [GitHub-28011](https://github.com/magento/magento2/issues/28011)
...
* 뉴스레터 구독자를 관리자로 삭제하기 위한 테스트를 추가했습니다. _끌어오기 요청 [28972](https://github.com/magento/magento2/pull/28972)_&#x200B;에서 Dmitry Tsymval이 제출한 수정 사항입니다. [GitHub-29032](https://github.com/magento/magento2/issues/29032)
...
* 새로 만든 고객의 `CustomerAddressId` 값이 이제 따옴표로 확인되었습니다. _가져오기 요청 [29139](https://github.com/magento/magento2/pull/29139)_&#x200B;에서 Andrii Kalinich가 제출한 수정 사항입니다. [GitHub-28793](https://github.com/magento/magento2/issues/28793)
