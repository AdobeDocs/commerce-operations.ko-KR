...
Adobe Commerce 및 Magento Open Source 2.4부터는 모든 설치를 사용하도록 구성해야 합니다 [Elasticsearch](https://www.elastic.co) 또는 [OpenSearch](https://opensearch.org/) 로서의 [카탈로그](https://glossary.magento.com/catalog) 검색 솔루션.
...
Adobe Commerce 또는 Magento Open Source 2.4.4를 설치하기 전에 OpenSearch 또는 Elasticsearch을 설치하고 구성해야 합니다.
...
자세한 내용은 [Elasticsearch 설명서](https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html).
