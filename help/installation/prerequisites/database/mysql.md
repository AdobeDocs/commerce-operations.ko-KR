...
>[!WARNING]
>
>Adobe Commerce은 현재 트랜잭션 내에서 `CREATE TEMPORARY TABLE` 문을 사용합니다. 이 문은 데이터베이스 구현에서 [Google Cloud SQL 2세대 인스턴스](https://dev.mysql.com/doc/refman/8.4/en/replication-gtids-restrictions.html)와 같은 GTID 기반 복제를 사용하는 [호환되지 않음](https://docs.cloud.google.com/sql/docs/features#differences)입니다. 대안으로 Cloud SQL 8.0용 MySQL을 고려해 보십시오.
