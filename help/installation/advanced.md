...
다음 표에서는 사용 가능한 많은 설치 매개 변수를 제공하지만 전부는 아닙니다. 전체 목록은 명령 줄 도구 참조[&#128279;](https://experienceleague.adobe.com/ko/docs/commerce-operations/tools/cli-reference/commerce-on-premises)를 참조하십시오.
