...
[클라우드 인프라의 Commerce](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/configure/service/services-yaml) 안내서에서 *서비스 구성*&#x200B;을 참조하십시오.
...
클라우드 구성 지침은 [클라우드 인프라의 상거래](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/configure/app/php-settings) 가이드의 *PHP 설정*&#x200B;을 참조하십시오.
...
>[!TIP]
>
>클라우드 인프라의 PHP 확장에 대해서는 [클라우드 인프라의 상거래](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/configure/app/php-settings#enable-extensions) 가이드에서 _PHP 확장 사용_&#x200B;을 참조하십시오.
...
Commerce Marketplace 및 기타 소스에서 얻은 응용 프로그램 및 확장을 업그레이드하려면 최대 2GB의 RAM이 필요합니다. 2GB 미만의 RAM을 사용하는 시스템을 사용하는 경우 [스왑 파일](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/troubleshooting/installation-and-upgrade/out-of-memory-error-during-install-or-upgrade)을 만듭니다. 그렇지 않으면 업그레이드가 실패할 수 있습니다.
...
Commerce on Cloud 인프라의 경우 [Commerce on Cloud Infrastructure](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/cdn/setup-fastly/fastly-configuration) 가이드의 *Factly configuration*&#x200B;을 참조하십시오.

### Xdebug

Adobe Commerce의 경우 [php_xdebug 2.5.x](https://xdebug.org/download) 이상을 사용하십시오(개발 환경에만 해당. 성능에 부정적인 영향을 줄 수 있음).

Adobe Commerce on Cloud의 경우 [Commerce on Cloud Infrastructure](https://experienceleague.adobe.com/ko/docs/commerce-on-cloud/user-guide/develop/test/debug) 가이드의 *Configure Xdebug*&#x200B;을 참조하십시오.

>[!NOTE]
>
>설치 후 Adobe Commerce 설치 또는 스토어프런트 또는 관리자에 대한 액세스에 영향을 줄 수 있는 `xdebug`에 알려진 문제가 있습니다. [Commerce Support Knowledge Base`xdebug`에서 &#x200B;](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/known-issues-that-affect-installation) 설치에 영향을 주는 알려진 문제&#x200B;_를 참조하십시오._
