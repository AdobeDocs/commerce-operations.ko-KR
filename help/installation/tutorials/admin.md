...
| `--admin-password` | 관리자 사용자 암호입니다. 암호는 12자 이상이어야 하며 최소 하나 이상의 영문자와 숫자를 포함해야 합니다. <br><br>Adobe에서는 더 길고 복잡한 암호를 지정할 것을 권장합니다. 암호 문자열에 리터럴 해석이 필요한 특수 문자(예: 백슬래시 또는 공백)가 포함된 경우 암호를 작은 따옴표로 묶습니다. | 예 |
