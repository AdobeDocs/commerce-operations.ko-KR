...
다음을 사용합니다. [작성기](https://getcomposer.org/) Adobe Commerce 및 Magento Open Source 구성 요소와 해당 종속성을 관리합니다. Composer를 사용하여 Adobe Commerce 및 Magento Open Source 가져오기 [메타패키지](https://glossary.magento.com/metapackage) 는 다음과 같은 이점을 제공합니다.
