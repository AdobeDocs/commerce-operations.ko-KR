...
사용 [작성기](https://getcomposer.org/) Adobe Commerce 및 Magento Open Source 구성 요소와 종속성을 관리합니다. Composer를 사용하여 Adobe Commerce 및 Magento Open Source 메타패키지를 얻으면 다음 이점이 있습니다.
