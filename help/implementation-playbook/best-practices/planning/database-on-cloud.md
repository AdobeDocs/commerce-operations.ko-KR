...
자세한 내용은 [Adobe Commerce 구성 가이드](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cli/manage-indexers.html#configure-indexers-1)에서 *인덱서 구성*&#x200B;을 참조하십시오.
