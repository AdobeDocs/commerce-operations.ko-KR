...
구현 세부 정보, 구성 예 및 배포별 지침은 성능 최적화를 위한 [L2 캐시 구성](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cache/level-two-cache)을 참조하십시오.
...
환경 구성에 대한 자세한 내용은 _Commerce on Cloud Infrastructure Guide_&#x200B;의 [`REDIS_BACKEND`](https://experienceleague.adobe.com/docs/commerce-cloud-service/user-guide/configure/env/stage/variables-deploy.html#redis_backend)을(를) 참조하십시오.
