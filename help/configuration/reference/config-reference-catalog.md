...
| 메타 키워드용 마스크 | `catalog/fields_masks/meta_keyword` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 메타 설명 마스크 | `catalog/fields_masks/meta_description` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 목록 모드 | `catalog/frontend/list_mode` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 그리드 허용 값의 페이지당 제품 수 | `catalog/frontend/grid_per_page_values` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 그리드의 페이지당 제품 수 기본값 | `catalog/frontend/grid_per_page` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 허용 값 목록의 페이지당 제품 수 | `catalog/frontend/list_per_page_values` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 목록의 페이지당 제품 수 기본값 | `catalog/frontend/list_per_page` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 게스트가 리뷰를 작성할 수 있도록 허용 | `catalog/review/allow_guest` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 제품 가격이 변경될 때 경고 허용 | `catalog/productalert/allow_price` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 가격 경고 이메일 템플릿 | `catalog/productalert/email_price_template` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 제품이 재고로 돌아올 때 경고 허용 | `catalog/productalert/allow_stock` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 스톡 경고 전자 메일 템플릿 | `catalog/productalert/email_stock_template` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 경고 전자 메일 보낸 사람 | `catalog/productalert/email_identity` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 현재 항목 표시 | `catalog/recently_products/scope` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 기본 최근에 본 제품 수 | `catalog/recently_products/viewed_count` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 기본 최근 비교 제품 수 | `catalog/recently_products/compared_count` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 기본 제품 가격 | `catalog/price/default_product_price` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
| 가격 간격을 하나의 가격으로 표시 | `catalog/layered_navigation/one_price_interval` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| Solr 서버 시간 초과 | `catalog/search/solr_server_timeout` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 인덱스 모드 | `catalog/search/engine_commit_mode` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 검색 제안 활성화 | `catalog/search/search_suggestion_enabled` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 검색 제안 수 | `catalog/search/search_suggestion_count` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 각 제안에 대한 결과 수 표시 | `catalog/search/search_suggestion_count_results_enabled` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 검색 Recommendations 활성화 | `catalog/search/search_recommendations_enabled` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
| 카테고리에 대한 정식 링크 메타 태그 사용 | `catalog/seo/category_canonical_tag` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 제품에 표준 링크 메타 태그 사용 | `catalog/seo/product_canonical_tag` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 활성화 | `catalog/magento_catalogpermissions/enabled` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 검색 카테고리 허용 | `catalog/magento_catalogpermissions/grant_catalog_category_view` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 고객 그룹 | `catalog/magento_catalogpermissions/grant_catalog_category_view_groups` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 랜딩 페이지 | `catalog/magento_catalogpermissions/restricted_landing_page` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 제품 가격 표시 | `catalog/magento_catalogpermissions/grant_catalog_product_price` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 고객 그룹 | `catalog/magento_catalogpermissions/grant_catalog_product_price_groups` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 장바구니에 추가 허용 | `catalog/magento_catalogpermissions/grant_checkout_items` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 고객 그룹 | `catalog/magento_catalogpermissions/grant_checkout_items_groups` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 카탈로그 검색 허용 안 함 | `catalog/magento_catalogpermissions/deny_catalog_search` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 주문 품목 상태를 통해 다운로드 활성화 | `catalog/downloadable/order_item_status` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 컨텐츠 처리 사용 | `catalog/downloadable/content_disposition` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 장바구니에 다운로드 가능한 항목이 포함되어 있으면 게스트 체크아웃 비활성화 | `catalog/downloadable/disable_guest_checkout` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| JavaScript 달력 사용 | `catalog/custom_options/use_calendar` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 연도 범위 | `catalog/custom_options/year_range` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 카탈로그 이벤트 기능 활성화 | `catalog/magento_catalogevent/enabled` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| Storefront에서 카탈로그 이벤트 위젯 활성화 | `catalog/magento_catalogevent/lister_output` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 이벤트 슬라이더 위젯에 표시할 이벤트 수 | `catalog/magento_catalogevent/lister_widget_limit` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 이벤트 슬라이더 위젯에서 클릭당 스크롤할 이벤트 | `catalog/magento_catalogevent/lister_widget_scroll` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 관련 제품 목록의 최대 제품 수 | `catalog/magento_targetrule/related_position_limit` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 관련 제품 표시 | `catalog/magento_targetrule/related_position_behavior` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 관련 제품 목록의 제품에 대한 순환 모드 | `catalog/magento_targetrule/related_rotation_mode` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 크로스셀 제품 목록의 최대 제품 수 | `catalog/magento_targetrule/crosssell_position_limit` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 크로스셀 제품 표시 | `catalog/magento_targetrule/crosssell_position_behavior` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 크로스셀 제품 목록의 제품에 대한 순환 모드 | `catalog/magento_targetrule/crosssell_rotation_mode` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 업셀 제품 목록의 최대 제품 수 | `catalog/magento_targetrule/upsell_position_limit` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
| 이름 | 구성 경로 | 상거래 전용? |
|--------------|--------------|--------------|
| 주문이 이행되었을 때 재고 감소 | `cataloginventory/options/can_subtract` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 주문이 취소될 때 품목의 상태를 재고 상태로 설정 | `cataloginventory/options/can_back_in_stock` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 재고 부족 제품 표시 | `cataloginventory/options/show_out_of_stock` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 왼쪽 X 임계값만 | `cataloginventory/options/stock_threshold_qty` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| Storefront에서 재고로 제품 가용성 표시 | `cataloginventory/options/display_product_stock_status` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 카탈로그와 동기화 | `cataloginventory/options/synchronize_with_catalog` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 재고 관리 | `cataloginventory/item_options/manage_stock` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 역주문 | `cataloginventory/item_options/backorders` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 지연된 Stock 업데이트 사용 | `cataloginventory/item_options/use_deferred_stock_update` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
| 장바구니에서 허용되는 최소 수량 | `cataloginventory/item_options/min_sale_qty` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 아래의 수량에 대해 알림 | `cataloginventory/item_options/notify_stock_qty` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
| 대변 메모 품목을 Stock에 자동으로 반품 | `cataloginventory/item_options/auto_return` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| 비동기식으로 실행 | `cataloginventory/bulk_operations/async` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 비동기 일괄 처리 크기 | `cataloginventory/bulk_operations/batch_size` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
이러한 구성 값은 의 관리자에서 사용할 수 있습니다 **스토어** > 설정 > **구성** > **카탈로그** > **Visual Merchandiser**.

| 이름 | 구성 경로 | 상거래 전용? |
|--------------|--------------|--------------|
| 카테고리 규칙의 표시 속성 | `visualmerchandiser/options/smart_attributes` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
| 최소 스톡 임계값 | `visualmerchandiser/options/minimum_stock_threshold` | ![상거래 전용](/help/assets/configuration/cloud-ee.png) |
...
| Sitemap에 이미지 추가 | `sitemap/product/image_include` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
이러한 구성 값은 의 관리자에서 사용할 수 있습니다 **스토어** > 설정 > **구성** > **카탈로그** > **RSS 피드**.

| 이름 | 구성 경로 | 상거래 전용? |
|--------------|--------------|--------------|
| RSS 사용 | `rss/config/active` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| RSS 사용 | `rss/wishlist/active` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
...
이러한 구성 값은 의 관리자에서 사용할 수 있습니다 **스토어** > 설정 > **구성** > **카탈로그** > **친구에게 이메일 보내기**.
