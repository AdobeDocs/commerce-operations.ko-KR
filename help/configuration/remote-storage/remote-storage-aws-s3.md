...
1. [AWS IAM](https://aws.amazon.com/iam/) 역할을 설정합니다. 또는 액세스 및 비밀 키를 생성합니다.
...
[AWS IAM](https://aws.amazon.com/iam/) 역할 대신 액세스 및 비밀 키를 사용하는 경우 [`ngx_aws_auth` Nginx 모듈](https://github.com/anomalizer/ngx_aws_auth)을(를) 포함해야 합니다.
