...
>[!IMPORTANT]
>
>Adobe Commerce 2.4.9 및 2.4.5-p16, 2.4.6-p14, 2.4.7-p9 및 2.4.8-p4 이상의 패치 릴리스에 대한 캐시 구성에 Valkey가 필요합니다. 릴리스별로 지원되는 캐시 서비스에 대해서는 [시스템 요구 사항](../../installation/system-requirements.md)을 참조하십시오.
