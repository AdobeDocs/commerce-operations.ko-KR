...
- **[[!DNL Managed Alerts]](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md)** - 주요 지표(CPU, 응용 프로그램 성능, 디스크, 메모리 및 데이터베이스 상태)를 모니터링하고 상인이 문제를 방지하고 다운타임을 피할 수 있도록 명확한 문제 해결 단계를 제공합니다.
