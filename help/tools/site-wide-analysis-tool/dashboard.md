...
* **[!UICONTROL Alerts]**: Adobe Commerce 인스턴스에 대한 최신 [!DNL New Relic Managed Alerts]을(를) 표시합니다. Adobe Commerce 지원 기술 자료에서 [Adobe Commerce에 대한 관리 경고](/help/tools/managed-alerts-for-adobe-commerce/managed-alerts-for-magento-commerce.md)와 [New Relic 서비스에 액세스](https://experienceleague.adobe.com/ko/docs/commerce-knowledge-base/kb/faq/access-new-relic-services)하는 방법에 대해 자세히 알아보세요.
