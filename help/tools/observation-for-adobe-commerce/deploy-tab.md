...
description: '[!UICONTROL Deploy]의  [!DNL Observation for Adobe Commerce] 탭에 대해 알아봅니다.'
...
* &#39;`%WARNING: [2010] Elasticsearch service is installed at infrastructure layer, but is not used as a search engine.%`&#39;(으)로 &#39;`es_not_used`)
