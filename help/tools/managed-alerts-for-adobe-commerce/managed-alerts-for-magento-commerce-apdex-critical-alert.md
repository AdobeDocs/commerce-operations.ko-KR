...
1. 소스가 식별되면 SSH를 환경에 추가하여 자세히 조사합니다. 단계는 Commerce on Cloud Guide의 [환경에 SSH](https://experienceleague.adobe.com/en/docs/commerce-cloud-service/user-guide/develop/secure-connections#ssh)를 참조하십시오.
