...
- 품질 패치 도구 {#quality-patches-tool}
  ...
  - 품질 패치 도구에서 사용할 수 있는 패치 {#patches-available-in-qpt}
    ...
    - v1.1.13 {#v1-1-13}
      ...
      - [MDVA-44188: &quot;.-&quot;가 포함된 ID로 이메일이 전송되지 않음](quality-patches-tool/patches-available-in-qpt/v1-1-13/mdva-44188-emails-are-not-sent.md)
    - v1.1.14 {#v1-1-14}
    ...
    - V1.1.27 {#v1-1-27}
      ...
      - [ACSD-48634: [!DNL Google Analytics Content Experiments] 사용 시  [!DNL JS] 오류 발생](quality-patches-tool/patches-available-in-qpt/v1-1-27/acsd-48634-js-errors-when-google-analytics-content-experiments-enabled.md)
    ...
    - v1.1.30 {#v1-1-30}
      ...
      - [B2B-2598: storeConfig, currency, country, country, availableStores GraphQl 쿼리에 캐싱 기능을 추가합니다.](quality-patches-tool/patches-available-in-qpt/v1-1-30/b2b-2598-add-caching-capability.md)
    ...
    - v1.1.35{#v1-1-35}
      ...
      - [ACSD-51149: [!UICONTROL Catalog Permissions]이(가) 활성화된 예약된 [!UICONTROL ImportExport]이(가) 인덱서를 무효화합니다.](quality-patches-tool/patches-available-in-qpt/v1-1-35/acsd-51149-scheduled-importexport-enabled-catalog-permissions-invalidates-indexers.md)
    ...
    - v1.1.36{#v1-1-36}
      ...
      - [ACSD-50887: [!UICONTROL Use in Search] 옵션 없이 [!UICONTROL Use in Search Results Layered Navigation]을(를) 예로 설정합니다.](quality-patches-tool/patches-available-in-qpt/v1-1-36/acsd-50887-product-attribute-use-in-search-results-layered-navigation-set-to-yes.md)
    ...
    - v1.1.43 {#v1-1-43}
      ...
      - [ACSD-54739: [!UICONTROL Related Product Rules]에 대해 [!UICONTROL Product Stock] 상태가 적용되지 않음](quality-patches-tool/patches-available-in-qpt/v1-1-43/acsd-54739-product-stock-status-not-applied-for-related-product-rules.md)
    ...
    - v1.1.48 {#v1-1-48}
      ...
      - [ACSD-55566:  [!DNL GraphQL] 응답에 내부 서버 오류가 발생하여 [!UICONTROL mergeCart] 돌연변이가 실패합니다.](quality-patches-tool/patches-available-in-qpt/v1-1-48/acsd-55566-mergecart-mutation-fails-with-an-internal-server-error-in-graphql-response.md)
    ...
    - v1.1.49 {#v1-1-49}
      ...
      - [ACSD-57045: [!UICONTROL Hierarchy]에서 [!UICONTROL Website Root]을(를) 선택 취소한 후 URL 재작성으로 인해 무한 페이지 루프가 발생합니다.](quality-patches-tool/patches-available-in-qpt/v1-1-49/acsd-57045-url-rewrites-cause-infinite-page-looping-after-website-root-unchecked-hierarchy.md)
    ...
    - v1.1.50 {#v1-1-50}
      ...
      - [ACSD-46938: :upgrade 설정 중 DB 트리거에 성능 문제가 발생했습니다.](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-46938-fix-for-db-triggers-performance-issue-during-setup-upgrade.md)
    ...
    - v1.1.55 {#v1-1-55}
      ...
      - [ACSD-61534: bin/magento config:set를 사용하여 디자인 구성을 설정할 수 없습니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-55/acsd-61534-design-configuration-cannot-set-using-bin-magento-config-set.md)
    ...
    - v1.1.67 {#v1-1-67}
      ...
      - [ACSD-65935: 제품이 삭제될 때 customerOrders GraphQL 쿼리에서 내부 서버 오류를 반환했습니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-65935-customerorders-graphql-query-returned-an-internal-server-error-when-a-product-was-deleted.md)
    ...
    - v1.1.68 {#v1-1-68}
      ...
      - [ACSD-66965: [!UICONTROL Requisition List] 페이지의 [!UICONTROL Print] 옵션에서 오류가 발생했습니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66965-print-option-on-requisition-list-page-causes-an-error.md)
    ...
    - v1.1.72 {#v1-1-72}
      ...
      - [ACSD-67424: GET /carts/search REST API 응답의 updated_at 값이 [!UICONTROL Negotiable Quotes]에 대한 [!UICONTROL Admin Panel]의 값과 일치하지 않습니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67424.md)
      ...
      - [ACSD-68011: /V1/sharedCatalog/:id/assignProducts API를 통해 공유 카탈로그에 할당된 존재하지 않는 SKU입니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68011.md)
    ...
    - v1.1.75 {#v1-1-75}
      ...
      - [ACSD-68517: [!UICONTROL Catalog] 및 [!UICONTROL Catalog Search] 페이지에서 양식 다시 제출 오류를 수정합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68517.md)
    ...
    - v1.1.76 {#v1-1-76}
      ...
      - [ACSD-69319: 하위 제품에 사용자 지정 소스 하에서의 재고가 있을 때 번들 제품 가격이 제대로 색인화되지 않았습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69319.md)
      - [ACSD-69086: 지원되지 않는 데이터베이스 버전 확인으로 인해 MariaDB 10.11에서 설치에 실패합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69086.md)
      - [ACSD-69331: 폴더 만들기 권한만 있는 관리자가 미디어 갤러리 폴더를 만들 수 없습니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69331.md)
      ...
      - [ACSD-69115: 기본이 아닌 웹 사이트에 할당된 고객의 관리 사용자에게 장바구니 오류가 표시되지 않음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69115.md)
      - [ACSD-67370: PDP/PLP의 번들 제품 및 다중 통화 스토어의 장바구니에 대한 잘못된 가격이 표시됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67370.md)
      ...
      - [ACSD-68410: 협상 가능한 견적 체크아웃에 의도하지 않은 장바구니 항목이 포함됩니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-68410.md)
      - [ACSD-69333: 활성 예약 업데이트가 있는 제품에 SKU 변경이 허용됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69333.md)
    - v1.1.77 {#v1-1-77}
    ...
    - v1.1.78 {#v1-1-78}
      ...
      - [ACP2E-4591: &quot;최초 구매자&quot;와 같이 주문 수에 따른 고객 세그먼트는 주문이 REST API를 통해 수행될 때 업데이트되지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4591.md)
      - [ACP2E-4732: 변경 로그 테이블의 version_id 열이 최대값에 도달하면 업데이트가 많은 고객에 대한 부분 인덱싱이 중지됩니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4732.md)
      - [ACP2E-4456: GraphQL 돌연변이가 있는 주문을 취소하면 기프트 카드로 완전히 결제된 주문이 마감됨 상태로 이동하지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4456.md)
      - [ACP2E-4452: 빠른 주문 페이지 제품 가격에는 세금 표시 구성에 관계없이 세금이 포함됩니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4452.md)
      - [ACP2E-4448:  [!DNL Redis] 중단 중에 변경된 구성은  [!DNL Redis] 복구 후 반영되지 않으며 부실 값은 유지됩니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4448.md)
      - [ACP2E-4665: 제품 갤러리에 비디오가 있는 구성 가능한 제품의 하위 제품은 REST API를 통해 요청할 때 표시되지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4665.md)
      - [ACP2E-4613: 큰 미디어 디렉토리로 인해 미디어 갤러리 디렉토리 트리 로드가 지연됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4613.md)
      - [ACP2E-4609: 일부 견적에 삭제된 제품이 포함되어 있으면 [!UICONTROL My Quotes] 페이지에 따옴표가 표시되지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4609.md)
      - [ACP2E-4416: 고객 보상 포인트는 관리자에서 생성 시 초기화되지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4416.md)
      - [ACP2E-4535: 비밀번호 분실 양식을 제출하면 세션이 삭제 또는 재생성되고(PHPSESSID 변경) 게스트 카트가 지워집니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4535.md)
      - [ACP2E-4507: [!UICONTROL Password Options] 구성은 GraphQL 돌연변이를 통해 수행된 고객 암호 재설정 요청에 적용되지 않습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4507.md)
      - [ACP2E-4431: 색인 재지정 프로세스 중에 대상 규칙과 일치하는 [!UICONTROL Related Products]이(가) 삭제됩니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4431.md)
      - [ACP2E-4540: Fotorama 라이브러리가 올바르게 로드되지 않으므로 첫 번째 첨부된 이미지만 표시됩니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4540.md)
      - [ACP2E-4555: 마침표 또는 슬래시를 포함하는 전화 번호가 올바르게 확인되지 않음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4555.md)
      - [ACP2E-4565: 회사 GraphQL 쿼리는 X-Adobe-Company 헤더가 사용될 때 &quot;현재 고객이 승인되지 않음&quot;을 반환합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4565.md)
      - [ACP2E-4522: 여러 장바구니 병합 또는 견적 저장 요청이 동시에 실행될 때 quote_couples 테이블에 간헐적인 중복 키 오류가 발생합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-78/acp2e-4522.md)
    ...
    - v1.1.80 {#v1-1-80}
      ...
      - [ACP2E-4493: 비동기 인덱싱이 활성화된 경우 판매 주문 보관 그리드에 잘못된 주문 상태가 표시됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4493.md) - [ACP2E-4239: 관리 그리드 날짜 필터가 시간대 불일치로 인해 결과를 반환하지 않음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4239.md)
      - [ACP2E-4481: 주문 취소 후 번들 제품 판매성이 잘못 계산됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4481.md)
      - [ACSD-53502: **[!UICONTROL Add to Cart]**&#x200B;이(가) iOS에서 간헐적으로 실패합니다 [!DNL Safari] . New Relic 스크립트 재귀가 원인입니다.](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acsd-53502.md)
      - [ACP2E-4813: 다중 패키지 주문에 대해 USPS 배송 방법을 사용할 수 없거나 잘못됨](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4813.md)
      - [ACP2E-4615: *PayPal 게이트웨이가 요청을 거부하므로 PayPal 온라인 주문 환불이 실패합니다. 내부 오류입니다.*](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4615.md)
      - [ACP2E-4610: `sales_clean_quotes` cron의 실행 속도가 느림](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4610.md)
      ...
      - [ACP2E-4653: 장바구니 가격 규칙 범주 범위 조건이  [!DNL REST] API에 없음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4653.md)
      - [ACP2E-4472: 고객으로 로그인 플로우를 사용하여 생성된 Null 견적](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4472.md)
      - [ACP2E-4808: 상점 내 측정 단위가 없는 제품 무게 표시](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4808.md)
      - [ACP2E-4533: URL에 스토어 코드가 포함된 경우 자리 표시자 이미지가 스토어에서 로드되지 않음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-80/acp2e-4533.md)
    ...
    - v1.1.81 {#v1-1-81}
      ...
      - [ACP2E-4395: 기프트 카드 제품은 글로벌 범위의 금액 없이 API를 통해 생성 할 수 있습니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4395.md)
      - [ACP2E-4401: 구성 가능한 제품이 [!UICONTROL maintenance page]&#x200B;(으)로 리디렉션되는 [!UICONTROL Home Page]의 [!UICONTROL Scheduled Update Preview]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4401.md)
      - [ACP2E-4468: 웹 사이트 범위 관리자 사용자가 페이지 빌더에 동적 블록을 저장할 수 없음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4468.md)
      - [ACP2E-4786: AWS S3 원격 스토리지가 구성되면 제품 내보내기가 실패합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4786.md)
      - [ACP2E-4801: Admin에서 협상가능 견적을 재구성할 때 번들 제품 옵션 수량이 업데이트되지 않음](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4801.md)
      - [ACP2E-4630: 긴 제품 이름이 페이지 나누기 후 다중 페이지 판매 PDF에서 인접한 열과 겹칩니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-81/acp2e-4630.md)
