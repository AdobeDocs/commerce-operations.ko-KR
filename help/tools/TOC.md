...
- 품질 패치 도구 {#quality-patches-tool}
   ...
   - 품질 패치 도구에서 사용할 수 있는 패치 {#patches-available-in-qpt}
      ...
      - v1.1.67 {#v1-1-67}
         ...
         - [ACSD-66084: row_total_incl_tax는 주문 API 응답에서 완전히 할인된 항목에 대해 0.00 대신 거의 0에 가까운 잔차 값을 반환합니다](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66084-fix-row-total-incl-tax-residual-value-for-discounted-items-in-order-api.md)
