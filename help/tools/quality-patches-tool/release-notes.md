...
* **ACSD-49389** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.7)에 대해) - 주문이 픽업될 준비가 되지 않은 경우 API에서 픽업 이메일을 보내는 문제를 수정합니다.
* **ACSD-49822** (Adobe Commerce >=2.3.7 &lt;2.4.7)에서 업데이트되는 문제가 해결되었습니다. [!UICONTROL Requisition List] 페이지가 [!UICONTROL Print Requisition List].
* **ACSD-48771** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)의 경우 - 열 블록 컨텐츠 유형을 이전 버전에서 업그레이드하는 문제가 해결되었습니다 [!DNL Page Builder] 버전.
* **ACSD-49464** (Adobe Commerce >=2.3.7 &lt;2.4.7)에 대해 - orderId가 다른 경우 송장, 선적 및 대변 메모가 아카이브에서 다시 이동되지 않는 문제를 수정합니다.
* **ACSD-49773** (Adobe Commerce 및 Magento Open Source >=2.4.2 &lt;2.4.6)의 경우 - AWS S3를 원격 저장소로 사용할 때 제품 내보내기가 실패하는 문제를 해결했습니다.
* **ACSD-49748** (Adobe Commerce >=2.3.7 &lt;2.4.7)에 대해 - 초대장을 보낼 수 없는 문제를 수정했습니다.
* **ACSD-49502** (Adobe Commerce >=2.4.3 &lt;2.4.7)의 경우 - 다운로드 가능한 제품에 스테이징 업데이트가 적용된 후 다운로드 가능한 링크가 제대로 업데이트되지 않는 문제를 수정합니다.
* **ACSD-49527** (Adobe Commerce >=2.4.2 &lt;2.4.7)의 경우 - GraphQL 회사 역할에 페이지 매김이 올바르게 표시되지 않는 문제가 수정되었습니다.
* **ACSD-49706** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)의 경우 - 값이 선택되어 있지 않을 때 기본 값이 시각적 견본 속성에 저장되는 문제가 수정되었습니다.
* **ACSD-49835** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)에 대해 다중 선택 속성에 대한 기본값 사용 확인란 값이 저장소 수준에서 올바르게 저장되지 않는 문제를 수정했습니다.
* **ACSD-49898** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6)의 경우 - 번들 제품에 특별 가격이 1000을 초과하는 경우 제품 그리드에 예외가 발생하는 문제를 수정했습니다.
* **ACSD-50234** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.5)에 대해 - 와 함께 주문을 할 경우 확인 이메일에서 잘못된 고객 이름으로 문제를 수정합니다 [!DNL PayPal].
* **ACSD-49960** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)에 대해 고객 주문 격자에 대해 날짜별 필터링이 작동하지 않는 문제를 수정했습니다.
* **ACSD-49849** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.6)에 대해) - 고객 이메일이 [!DNL PayPal] 을 사용하여 주문 배치 시 이메일 [!DNL PayPal Express] GraphQL을 통해
* **ACSD-49839** (Adobe Commerce >=2.3.7 &lt;2.4.7)에 대해 - SKU에서 제품이 단일 또는 큰 따옴표가 있을 때 공유 카탈로그 가격 책정 및 구조에 관리자에게 오류가 발생하는 문제를 수정합니다.
* **ACSD-49970** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)의 경우) - 다음의 경우 GraphQL 오류를 잘못 처리하는 문제가 해결되었습니다. [!DNL New Relic] 보고가 설정되어 있습니다.
* **ACSD-50260** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)의 경우 - GraphQL 제품 검색 결과가 10,000개의 결과로만 제한되는 문제를 수정했습니다.
* **ACSD-48813** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.7)에 대해) - 속성의 검색 가중치를 기반으로 하여 검색에 관련 결과가 표시되지 않는 문제가 수정되었습니다.

## v1.1.28 {#v1-1-28}

* **ACSD-48204** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.3)에 대해) - 예/아니오 속성을 기반으로 만들어진 카탈로그 가격 규칙이 선택한 범위를 고려하지 않는 문제를 수정합니다.
* **ACSD-47704** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해) - 번들 제품이 스톡 제품의 가격만 표시되는 문제를 수정합니다.
* **ACSD-49370** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7) - *날짜 시간* 제품 속성에 *FilterMatchTypeInput* GraphQL 스키마 입력.
* **ACSD-48807** (Adobe Commerce 및 Magento Open Source >=2.4.1 &lt;2.4.7)에 대해) - 고객 제품 검토가 GraphQL을 통해 storeview로 필터링되지 않는 문제를 수정합니다.
* **ACSD-49433** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.7)에 대해 - 기본 금액이 열린 기프트 카드의 장바구니에 소결로 표시되는 문제를 수정합니다.
* **ACSD-48866** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해 RSS 피드를 카테고리에 대해 요청할 때 오류가 발생하는 문제를 수정합니다.
* **ACSD-48784** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해 고객 그룹 간에 고객 세그먼트 가격이 잘못 캐시되는 문제를 수정합니다.
* **ACSD-48857** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.7)의 경우 - Page Builder로 편집한 후 사용자가 변경 사항을 저장할 수 없는 문제가 해결되었습니다.
* **ACSD-49065** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해) - 사용자 지정 재고에만 할당된 경우 관리에서 견적 항목이 표시되지 않는 문제가 해결되었습니다.
* **ACSD-49179** (Adobe Commerce 및 Magento Open Source >=2.4.2 &lt;2.4.7)의 경우 - 서로 다른 스토어에 대한 다른 통화의 경우 주문 보고서에 잘못된 금액이 표시되는 문제가 수정되었습니다.
* **ACSD-49286** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.7)의 경우 - 페이지에 여러 제품 위젯이 있을 때 제품이 장바구니에 두 번 추가되는 문제를 수정합니다.
* **ACSD-49574** (Adobe Commerce >=2.4.4 &lt;2.4.7) - GraphQL을 통해 카트에서 기프트 카드 제품 업데이트를 지원하는 기능을 추가합니다.
* 업데이트된 패치: ACSD-48694.

## v1.1.27 {#v1-1-27}

* **ACSD-48362** (Adobe Commerce >=2.4.1 &lt;2.4.7)의 경우 - 협상 가능한 견적을 사용하여 주문을 제출할 때 새 배송 주소가 아닌 기본 배송 주소가 사용되는 문제를 수정합니다.
* **ACSD-48059** (Adobe Commerce >=2.3.7 &lt;2.4.7) - 상인이 &quot;[!UICONTROL Match product by rule]&quot;&quot;을 입력합니다.
* **ACSD-48216** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.3.8 || >=2.4.0 &lt;2.4.7) - 다음과 같은 문제가 해결되었습니다. [!UICONTROL AUTO_INCREMENT] 의 [!UICONTROL inventory_source_item] 표 증가 [!UICONTROL UPDATE] 작업.
* **ACSD-47908** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.3.8 || >=2.4.0 &lt;2.4.7) - 체크아웃 중에 운송 단계에서 소스와 수량을 선택할 때 &quot;0보다 작거나 같은 값이 예상됨&quot;이라는 오류를 수정합니다.
* **ACSD-49497** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.6)의 경우 - 출하 후 주문이 처리 상태로 남아 있고 부분 환불이 적용되는 문제가 수정되었습니다.
* **ACSD-48694** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.3.8 || >=2.4.1 &lt;2.4.7) - &quot;잘못된 상태 변경이 요청됨&quot;으로 인해 고객이 주문을 하지 못하는 문제가 해결되었습니다.
* **ACSD-49013** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.7)에서 벌크 API를 사용하여 고객을 만들 때 이메일 확인이 웹 사이트 로케일로 번역되지 않는 문제를 수정했습니다.
* **ACSD-48164** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해) - 제한된 관리자가 웹 사이트 수준 값을 저장할 수 없는 문제가 해결되었습니다.
* **ACSD-48404** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.4)의 경우) - 브라우저의 뒤로 단추를 누를 때 &quot;카테고리 페이지 기억 = 예&quot;가 오류가 발생하는 문제를 수정했습니다.
* **ACSD-48634** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7) - 다음과 같은 경우 스테이징 업데이트 페이지의 JS 오류를 수정합니다.[!UICONTROL Google Analytics Content Experiments]이 활성화되어 있습니다.
* **ACSD-49042** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.5)의 경우 - Storefront에서 무한 역주문이 있는 제품을 주문할 수 없는 문제를 수정합니다.
* 업데이트된 패치: ACSD-48366, ACSD-48661.

## v1.1.26 {#v1-1-26}

* **ACSD-47937** (Adobe Commerce 및 Magento Open Source 2.4.4용) || >=2.4.5 &lt;2.4.6) - 애플리케이션 수준 캐싱으로 인해 가격 하락 알림이 항상 전송되지 않는 문제를 해결했습니다.
* **ACSD-48661** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)에 대해 - 회사의 신용 한도가 999보다 큰 경우, 쉼표 구분자가 유효성 검사 오류로 인해 회사 저장을 방지하는 문제가 해결되었습니다.
* **ACSD-48773** (Adobe Commerce 및 Magento Open Source >=2.4.2 &lt;2.4.7)에 대해 - 리워드가 잘못된 스토어에서 이메일 템플릿을 가져오는 문제를 수정합니다.
* **ACSD-48587** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.7)의 경우 - 제품 위젯 일치 규칙에서 HTML 특수 문자가 일치하는 제품을 표시하지 못하는 문제가 해결되었습니다.
* **ACSD-48212** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.6)에 대해 - 제품 가져오기가 제품을 잘못된 소스에 할당하는 문제가 해결되었습니다.
* **ACSD-47988** (Adobe Commerce 및 Magento Open Source >=2.3.7 &lt;2.4.6)에 대해) - 제품 내보내기에서 페이지 빌더 제품 설명에서 HTML 태그를 실행하는 문제가 수정되었습니다.
* **ACSD-48366** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6)에 대해) - 제품 이미지가 스톡 메시지로 돌아가기 이메일 템플릿에 표시되지 않는 문제를 수정합니다.
* **ACSD-48417** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.7)의 경우 - 제품에 대한 예약 변경을 만들고 다른 제품을 저장한 후 SQL 오류가 표시되는 문제를 수정합니다.

## v1.1.25 {#v1-1-25}

* **ACSD-48058** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.6)에 대해 번들 제품이 웹 사이트에 할당되지 않은 경우 제품 가격 재색인이 작동하지 않는 문제를 수정했습니다.
* **ACSD-48262** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.6)의 경우 - &quot;페이지당 모든 제품 허용&quot; 설정이 예로 설정되어 있을 때 제품이 전방에 표시되지 않는 문제가 해결되었습니다.
* **ACSD-48293** (Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;2.4.4)에 대해) - 매진된 하위 제품이 재고로 반환될 때 복합 제품이 재고가 부족한 문제를 해결했습니다.
* **ACSD-47520** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.6)에 대해) - 대변 메모가 작성될 때 고객이 보상 점수를 잃어버리는 문제를 수정합니다.
* **ACSD-48044** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.4.4)의 경우 - 다중 배송이 있는 단일 주문에 여러 선물 카드를 적용하여 주문이 실행되지 않는 문제를 해결했습니다.
* **ACSD-48300** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.6)의 경우 - 구성 가능한 제품을 제거할 경우 반품을 만들 수 없는 문제가 해결되었습니다.
* **ACSD-47910** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6) - 각 엔티티 그리드에서 주문, 송장, 선적 및 대변 메모가 누락되는 문제를 수정합니다.
* **ACSD-47292** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6)의 경우 - &quot;재고 부족 제품 표시&quot;가 예로 설정된 경우 GraphQL 응답에서 재고 부족 번들 제품을 사용할 수 없는 문제가 수정되었습니다.
* **ACSD-48234** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.6)의 경우 - &quot;재고 부족&quot; 옵션이 활성화될 때 카탈로그 검색 결과에 잘못된 카테고리 항목 수가 표시되는 문제를 수정합니다.
* **ACSD-48313** (Adobe Commerce 및 Magento Open Source >=2.4.0 &lt;2.4.5)에 대해) - 속성 값에 쉼표가 포함되어 있는 경우 &quot;configurable_variations&quot; 열이 구문 분석되지 않는 문제를 수정합니다. &quot;additional_attributes에 동일한 구문 분석 알고리즘이 사용됩니다.
* **ACSD-48627** (Adobe Commerce 및 Magento Open Source >=2.4.5 &lt;2.4.6)의 경우 - 재고 부족 구성 가능한 제품에서 GraphQL 요청을 보내 장바구니 세부 사항을 가져올 때 오류가 발생하는 문제를 수정합니다.
* 업데이트된 패치: MDVA-39384.
...
* **ACSD-47955** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6)에서 GraphQL에 장바구니 할인이 올바로 표시되지 않는 문제가 수정되었습니다.
...
* **ACSD-46988** (Adobe Commerce 및 Magento Open Source >=2.4.4 &lt;2.4.6)에 대해 GraphQL &#39;currency&#39; API 요청이 사용자 지정 통화에 대해 NULL 값을 반환하는 문제가 해결되었습니다.
...
* **ACSD-45817** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.4*) - 특정 저장소에 대한 GraphQL 제품 돌연변이가 요청된 스토어에 할당되지 않은 변형을 포함하여 구성 가능한 모든 변형을 반환하는 문제를 수정했습니다.
...
* **ACSD-45257** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.3.4 &lt;2.4.4*) - GraphQL에 장바구니 할인이 올바로 표시되지 않는 문제를 수정했습니다.
* **ACSD-44938** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.0 &lt;2.4.4*) - 다음 위치의 문제를 수정합니다. `VAT_ID` 게스트 사용자에 대한 GraphQL 요청에서 적용할 수 없습니다.
* 업데이트된 패치: MDVA-43417.
...
* **MDVA-44562** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.0 &lt;2.4.2-p2*) - 비기본 스토어 보기에서 시작된 GraphQL 요청에도 불구하고 견적 항목에 대한 기본값이 아닌 스토어 ID가 기본 스토어 ID로 재정의되는 문제를 수정합니다.
...
* **MDVA-43862** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.3.3 &lt;2.4.5*) - GraphQL으로 인해 고객이 장바구니 항목을 업데이트할 수 없는 문제를 수정했습니다 *UpdateCartItems 변형* 오류가 발생했습니다.
...
* **MDVA-43348** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.5*) - 다음의 경우 기프트 카드 GraphQL 요청에 오류가 표시되는 문제를 수정합니다. `gift_card_options` contain *uid*.
...
* **MDVA-41305** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.5*) - GraphQL 돌연변이가 구성 가능한 제품 옵션을 희망 목록에 추가한 후 반환하지 않는 문제를 수정했습니다.
...
* **MDVA-42341** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.4*) - `categoryList` 요청에 스토어 헤더가 있는 경우 GraphQL 쿼리가 결과를 필터링하지 않습니다.
...
* **MDVA-41631** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.1 &lt;2.4.4*) - 옵션 없이 주문 정보를 검색하려고 할 때 오류가 발생하는 문제를 수정합니다 *전화* GraphQL을 통해 얻을 수 있는 이점
...
* **MDVA-40120** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.1 &lt;2.4.4*) - DESC/ASC별로 GraphQL 정렬이 관련성 또는 가격이 동일한 제품에서 작동하지 않는 문제를 수정합니다.
...
* **MDVA-39031** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.1 &lt;2.4.4*) - 타겟 웹 사이트에 할당되지 않은 경우에도 GraphQL을 통해 장바구니에 제품을 추가할 수 있는 문제를 수정했습니다.
* **MDVA-41597** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.4*) - GraphQL을 사용하여 장바구니에 구성 가능한 제품을 두 개 이상 추가할 때 사용자에게 오류가 발생하는 문제를 수정합니다.
...
* **MDVA-40435** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.3.4 &lt;2.4.4*) - GraphQL을 통해 적용할 때 동적 가격이 있는 번들 제품에 대한 잘못된 할인이 발생하는 문제를 수정합니다.
* **MC-42528** (*Adobe Commerce 및 Magento Open Source >=2.4.3 &lt;=2.4.3-p1*) - `categoryList` GraphQL 쿼리는 할당된 카테고리와 할당되지 않은 카테고리를 모두 반환합니다.
...
* **MDVA-40262** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.4*) - GraphQL 검색 쿼리가 관리자의 인기 있는 검색어에 표시되지 않던 문제를 해결했습니다.
* **MDVA-40601** (*Adobe Commerce 및 Magento Open Source >=2.3.1의 경우 &lt;=2.4.2-p2*) - GraphQL을 통해 예약된 업데이트로 변경된 카테고리에 대한 정보를 사용자가 가져오려고 하면 오류가 발생하는 문제를 수정합니다.
...
* **MDVA-39521** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.0 &lt;2.4.4*) - 사용자가 GraphQL을 통해 전화 번호가 비어 있는 장바구니에서 배송 주소를 설정할 수 없는 문제를 수정합니다.
...
* **MDVA-38447** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.4*) - 다음 두 가지 문제가 해결되었습니다. 여기서 *개별적으로 표시되지 않음* 구성 가능한 하위 제품은 GraphQL 응답으로 반환되고, 카테고리 필터를 사용하여 GraphQL 제품 쿼리에 대한 MySQL 쿼리를 최적화합니다.
* **MDVA-40134** (*Adobe Commerce 및 Magento Open Source의 경우 >=2.4.2 &lt;2.4.3*) - 공유 카탈로그가 활성화되어 있을 때 GraphQL에서 관련 제품을 반환하지 않는 문제를 수정했습니다.
...
* **MDVA-38270** (*Adobe Commerce >=2.4.1 &lt;2.4.3>*) - GraphQL의 주문 총계에서 기프트 카드 정보가 누락되는 문제를 수정했습니다.
...
* **MDVA-37288** (*Adobe Commerce 2.4.2*) - GraphQL 요청 후 잘못된 계층 가격이 반환되던 문제를 수정합니다.
...
* **MDVA-30186** (*Adobe Commerce >=2.3.4 &lt;=2.3.5-p2, >=2.4.0 &lt;=2.4.0-p1, >=2.4.2 &lt;=2.4.2-p1*) - 속성 옵션이 GraphQL 응답에서 속성 항목 수 대신 옵션 값별로 정렬되는 문제를 수정했습니다.
...
* **MDVA-36170** (*Adobe Commerce >=2.3.4 &lt;2.4.2>*) - 카테고리 캐시 태그를 사용하여 GraphQL 쿼리가 캐시되지 않는 문제가 해결되었습니다.
...
* **MDVA-35312** (*Adobe Commerce >=2.4.1-p1 &lt;2.4.2*) - 빈 GraphQL 요청 시 응답 코드 500을 수정합니다.
...
* **MDVA-35197** (*Adobe Commerce >=2.3.5 &lt;2.4.0>*) - 이전에 추가한 제품의 재고가 바닥난 경우 GraphQL을 사용하여 장바구니에 추가할 때 오류가 발생하는 문제를 수정합니다.
...
* **MDVA-32714** (*Adobe Commerce >=2.3.4 &lt;2.4.1*) - 고객 그룹 가격이 GraphQL 제품 쿼리에서 작동하지 않는 문제를 수정했습니다.
...
* **MDVA-31363** (*Adobe Commerce >=2.3.2 &lt;2.4.2>*) - 쿠폰이 있는 장바구니 가격 규칙이 *전체 장바구니에 대한 고정 금액 할인* 작업이 사용됩니다.
...
* **MDVA-30123** (*Adobe Commerce >=2.3.4 &lt;2.4.2>*) - GraphQL 쿼리에 대한 속성 옵션 레이블이 올바르게 번역되지 않는 문제를 수정했습니다.
