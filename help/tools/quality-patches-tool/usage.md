---
title: 사용
description: 품질 패치 도구 를 사용하여 Adobe Commerce에 대한 패치를 적용하고 관리하는 방법을 알아봅니다. 테스트, 애플리케이션 및 패치 관리 기술에 대해 알아봅니다.
...
>[!INFO]
>
>아직 설치되지 않은 경우 [!DNL Quality Patches Tool]을(를) 설치하기 전에 [[!DNL Git]](https://github.com/git-guides/install-git) 또는 [패치](https://man7.org/linux/man-pages/man1/patch.1.html)을(를) 설치해야 합니다. `composer.json` 파일에 `magento/quality-patches` 작성기 패키지 추가:
