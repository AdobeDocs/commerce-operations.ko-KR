...
1. **[ACP2E-4402](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4402.md)**: 사용하지 않도록 설정된 제품이 사용하도록 설정된 후 관련 [!UICONTROL Target Rule] 결과에 다시 추가되지 않는 문제를 해결했습니다.
...
1. **[ACP2E-4706](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-79/acp2e-4706.md)**: [!UICONTROL Target Rule] 인덱서가 관리 범위에서 활성화되지 않은 제품을 건너뛰는 문제를 해결했습니다.
