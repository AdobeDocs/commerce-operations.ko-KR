...
MDVA-40830 패치는 주문 배치 중에 스토어 크레딧이 여러 번 적용되는 문제를 해결합니다. 이 패치는 [품질 패치 도구(QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.11이 설치된 경우에 사용할 수 있습니다. 패치 ID는 MDVA-40830입니다. 이 문제는 Adobe Commerce 2.4.5에서 수정됩니다.
