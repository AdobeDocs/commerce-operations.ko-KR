...
description: ACP2E-4050 패치를 적용하여 [!UICONTROL Cart Price Rules]에 하위 선택 조건 및 특정 가격의 제품이 포함된 경우 다중 주소 체크아웃 동안 [!UICONTROL Free Shipping]이(가) 적용되지 않는 Adobe Commerce 문제를 해결합니다.
...
**[!UICONTROL Cart Price Rules]**&#x200B;에 하위 선택 조건 및 특정 가격의 제품이 포함된 경우 **[!UICONTROL Free Shipping]**&#x200B;은(는) 다중 배달 체크아웃 중에 적용되지 않습니다.
