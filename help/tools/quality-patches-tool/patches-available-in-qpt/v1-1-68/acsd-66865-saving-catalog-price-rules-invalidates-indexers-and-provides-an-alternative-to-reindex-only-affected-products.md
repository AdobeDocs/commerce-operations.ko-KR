...
description: ACSD-66865 패치를 적용하여 [!UICONTROL Catalog Price Rules]을(를) 저장하면 인덱서가 무효화되고 영향을 받는 제품만 다시 인덱싱하는 대안을 제공하는 Adobe Commerce 문제를 해결합니다.
...
3. 백로그에 *0* 항목이 있는 모든 인덱스가 *[!UICONTROL Ready]* 상태를 표시하는지 확인하십시오.
