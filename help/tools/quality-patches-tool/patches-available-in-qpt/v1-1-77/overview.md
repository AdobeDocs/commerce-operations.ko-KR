...
1. **ACSD-69351**: 기프트 카드 잔액과 만료 날짜가 잘못된 웹 사이트에 표시되는 문제를 해결했습니다.
1. **ACSD-69311**: 송장의 일부 환불 후 대변 메모의 잘못된 세금 계산을 수정합니다.
1. **ACSD-69494**: `is_online`을(를) 사용하여 비동기 환불 요청을 수정하면 온라인 환불이 트리거되지 않습니다.
