...
1. **[ACSD-69203](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)**: 범주 조건에 여러 범주가 나열되어 있을 때 **[!UICONTROL Products List]** 위젯에서 잘못된 결과를 반환하는 문제를 해결했습니다.
