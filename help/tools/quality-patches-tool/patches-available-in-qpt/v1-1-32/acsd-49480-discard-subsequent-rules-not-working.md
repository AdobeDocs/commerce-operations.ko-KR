...
1. **[!UICONTROL Cart Price Rule]**&#x200B;이(가) *(으)로 설정되고*&#x200B;이(가) *1*(으)로 설정된 **[!UICONTROL Actions]** 탭에서 [!UICONTROL Discard Subsequent Rules]제품 ID 1 *[!UICONTROL Yes]*&#x200B;에 $10 할인을 제공하는 쿠폰 코드(이름: [!UICONTROL Priority]TEST *)로*&#x200B;을(를) 만듭니다.
1. **[!UICONTROL Cart Price Rule]**&#x200B;이(가) *2*(으)로 설정된 **[!UICONTROL Actions]** 탭에서 [!UICONTROL Priority]제품 ID 2 *에 $5 할인을 제공하는 쿠폰 코드 없이 다른*&#x200B;을(를) 만드십시오. 여기에서 *제품 ID 2*&#x200B;에 대한 글로벌 세일이라고 가정합니다.
