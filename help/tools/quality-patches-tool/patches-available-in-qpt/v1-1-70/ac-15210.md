...
패치를 적용한 후 Commerce USPS Shipping Carrier 구성을 업데이트하여 새 USPS API와 통합합니다. 지침은 *스토어 및 구매 경험 안내서*&#x200B;의 [USPS 웹 도구 사용 중단](https://experienceleague.adobe.com/ko/docs/commerce-admin/stores-sales/delivery/shipping-carriers/carriers#usps-web-tools-api-deprecation) 항목을 참조하십시오.
