...
1. **[!UICONTROL Stores]** > **[!UICONTROL Tax Zones and Rates]** > **[!UICONTROL Add new Tax Rate]**(으)로 이동합니다.
   ...
   1. **[!UICONTROL Rate Percent]** 필드에 *20.000000*&#x200B;을(를) 입력하십시오.
...
1. **[!UICONTROL Catalog]** > **[!UICONTROL Products]** > **[!UICONTROL Add Product]**(으)로 이동합니다.
   1. **[!UICONTROL Product Name]** 필드에 *test*&#x200B;을(를) 입력하십시오.
   1. **[!UICONTROL SKU]** 필드에 *test*&#x200B;을(를) 입력하십시오.
   1. **[!UICONTROL Price]** 필드에 **82.65**&#x200B;을(를) 입력하십시오.
   1. **[!UICONTROL Tax Class]**&#x200B;을(를) *과세 대상*(으)로 설정합니다.
   1. **[!UICONTROL Quantity]** 필드에 *100*&#x200B;을(를) 입력하십시오.
   1. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
...
1. **[!UICONTROL Marketing]** > *[!UICONTROL Promotions]* > **[!UICONTROL Catalog Price Rule]** > **[!UICONTROL Add New Rule]**(으)로 이동합니다.
   ...
   1. **[!UICONTROL Discount Amount]** 필드에 *20.000000*&#x200B;을(를) 입력하십시오.
   1. **[!UICONTROL Save]**&#x200B;을(를) 클릭합니다.
1. 전체 색인 재지정을 수행합니다.
...
1. **[!UICONTROL Store]**: 헤더에 설정된 *default*(으)로 다음 [!DNL GraphQL] 쿼리를 수행합니다.
