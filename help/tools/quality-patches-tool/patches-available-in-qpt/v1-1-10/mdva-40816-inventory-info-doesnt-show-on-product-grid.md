...
MDVA-40816 패치는 제품 SKU에 특수 문자가 포함된 경우 제품 그리드에 인벤토리 정보가 표시되지 않는 문제를 해결합니다. 이 패치는 [품질 패치 도구(QPT)](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10이 설치된 경우에 사용할 수 있습니다. 패치 ID는 MDVA-40816입니다. 이 문제는 Adobe Commerce 2.4.5에서 수정됩니다.
