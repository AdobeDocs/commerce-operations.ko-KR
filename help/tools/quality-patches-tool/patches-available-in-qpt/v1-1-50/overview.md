...
1. **ACSD-58141**: `PHPSESSID`이(가) 사용되고 고객이 관리에서 업데이트되는 경우 로그인한 고객의 상점 영역에 대한 POST 요청에서 [!UICONTROL L2 Redis cache]이(가) 다시 발생하는 문제가 해결되었습니다.
...
1. **ACSD-58790**: *의 모바일 보기에서 제품 세부 사항 페이지 이미지에 대한*&#x200B;핀치-투-줌[!DNL Chrome] 기능을 수정합니다.
