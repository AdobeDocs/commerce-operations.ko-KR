...
ACSD-60303 패치는 HTML 축소가 활성화된 경우 관리자로부터 주문을 할 수 없는 문제를 수정합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.50이 설치된 경우에 사용할 수 있습니다. 패치 ID는 ACSD-60303입니다. 이 문제는 2.4.8에서 수정될 예정입니다.
