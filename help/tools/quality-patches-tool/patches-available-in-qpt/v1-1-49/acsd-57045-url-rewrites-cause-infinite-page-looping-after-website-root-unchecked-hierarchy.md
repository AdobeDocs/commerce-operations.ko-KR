---
title: 'ACSD-57045: [!UICONTROL Website Root]에서 [!UICONTROL Hierarchy]을(를) 선택 취소한 후 URL 재작성으로 인해 무한 페이지 루프가 발생합니다.'
description: ACSD-57045 패치를 적용하여 [!UICONTROL Website Root]에서 [!UICONTROL Hierarchy]을(를) 선택 취소한 후 URL 재작성으로 인해 무한 페이지 루프가 발생하는 Adobe Commerce 문제를 해결합니다.
feature: CMS
...
**[!UICONTROL Website Root]**&#x200B;에서 **[!UICONTROL Hierarchy]**&#x200B;을(를) 선택 취소한 후 URL 재작성으로 인해 무한 페이지 루프가 발생합니다.
