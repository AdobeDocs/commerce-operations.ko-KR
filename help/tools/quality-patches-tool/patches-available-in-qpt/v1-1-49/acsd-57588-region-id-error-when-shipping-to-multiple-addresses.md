...
ACSD-57588 패치는 주문을 여러 주소로 배송하면 지역 ID 처리 중에 오류가 발생하는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49가 설치된 경우에 사용할 수 있습니다. 패치 ID는 ACSD-57588입니다. 이 문제는 Adobe Commerce 2.4.7에서 해결되었습니다.
