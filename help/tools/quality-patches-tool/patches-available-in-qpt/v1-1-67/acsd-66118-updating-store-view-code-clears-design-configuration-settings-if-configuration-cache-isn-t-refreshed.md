...
**[!UICONTROL Configuration Cache]**&#x200B;을(를) 새로 고치지 않으면 **[!UICONTROL Store View Code]** 필드를 업데이트할 때 **[!UICONTROL Design Configuration]** 설정(테마 및 사용자 지정 설정 등)이 지워집니다.
...
6. 업데이트된 **[!UICONTROL Store View]**&#x200B;의 **[!UICONTROL Content]** > *[!UICONTROL Design]* > **[!UICONTROL Configuration]** 페이지를 새로 고치거나 다시 열면 테마가 선택되지 않습니다.
