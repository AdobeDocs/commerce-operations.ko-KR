...
1. [!DNL RabbitMQ]필수 구성 요소[[!DNL RabbitMQ] 의 지침에 따라 ](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/message-brokers/rabbitmq)을(를) 구성합니다.
