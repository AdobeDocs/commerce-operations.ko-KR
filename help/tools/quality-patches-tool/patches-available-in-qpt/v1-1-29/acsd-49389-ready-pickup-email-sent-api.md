...
QPT에서 사용할 수 있는 다른 패치에 대한 정보는 [ 안내서의 ](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html)QPT에서 사용할 수 있는 패치[!DNL Quality Patches Tool]를 참조하세요.
