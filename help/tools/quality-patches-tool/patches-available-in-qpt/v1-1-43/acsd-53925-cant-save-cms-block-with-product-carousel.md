...
ACSD-53925 패치는 *[!UICONTROL Product Carousel]*&#x200B;에 대한 차원 모드가 웹 사이트로 설정된 경우 관리자가 `catalog_product_price`과(와) 함께 CMS 블록을 저장할 수 없는 문제를 해결합니다. 이 패치는 [!DNL Quality Patches Tool (QPT)] 1.1.43이 설치된 경우에 사용할 수 있습니다. 패치 ID는 ACSD-53925입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
...
*[!UICONTROL Product Carousel]*&#x200B;에 대한 차원 모드가 웹 사이트로 설정된 경우 관리자는 `catalog_product_price`을(를) 사용하여 CMS 블록을 저장할 수 없습니다.
