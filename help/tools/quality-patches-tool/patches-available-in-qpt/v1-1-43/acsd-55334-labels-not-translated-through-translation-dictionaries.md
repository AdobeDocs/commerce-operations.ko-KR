...
ASCD-55334 패치는 GraphQL 응답의 번역 사전을 통해 레이블이 번역되지 않는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43이 설치된 경우에 사용할 수 있습니다. 패치 ID는 ASCD-55334입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
