...
ACSD-49574 패치는 기프트 카드 제품을 GraphQL을 통해 장바구니에서 업데이트할 수 없는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.28이 설치된 경우에 사용할 수 있습니다. 패치 ID는 ACSD-49574입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
