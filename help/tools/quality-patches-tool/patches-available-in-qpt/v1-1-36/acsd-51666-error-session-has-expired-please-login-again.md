...
description: ACSD-51666 패치를 적용하여 *세션이 만료된 Adobe Commerce 문제를 해결합니다. 다시 로그인하십시오.* 로그인을 시도한 후 발생합니다.
feature: Customers
...
오류 *세션이 만료되었습니다. 다시 로그인하십시오.* 다른 장치에서 암호를 재설정한 후 한 장치에서 새 암호로 로그인하려고 할 때 사용자 지정 모듈에서 추가한 페이지에 추가 Ajax 요청이 있는 경우에만 발생합니다.
