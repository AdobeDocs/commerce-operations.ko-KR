...
ACSD-53979 패치는 시작 메시지에 작은 따옴표가 포함된 경우 홈 페이지에서 JavaScript 오류가 발생하는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37이 설치되어 있을 때 사용할 수 있습니다. 패치 ID는 ACSD-53979입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
