...
ACSD-47054 패치는 저장소가 많을 때 콘텐츠 스테이징 미리보기를 로드하는 데 시간이 더 오래 걸리는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.37이 설치되어 있을 때 사용할 수 있습니다. 패치 ID는 ACSD-47054입니다. 이 문제는 Adobe Commerce 2.4.6에서 해결되었습니다.
