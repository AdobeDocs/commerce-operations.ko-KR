---
title: 'ACSD-48634: [!DNL JS] 사용 시  [!DNL Google Analytics Content Experiments] 오류 발생'
description: ' [!DNL JS] 이(가) 활성화된 경우  [!DNL staging] 업데이트 페이지에서  [!DNL Google Analytics Content Experiments] 오류를 수정하려면 ACSD-48634 패치를 적용하십시오.'
...
# ACSD-48634: [!DNL JS]을(를) 사용할 때 [!DNL Google Analytics Content Experiments]개의 오류 발생

ACSD-48634 패치는 [!DNL JS]을(를) 사용하도록 설정할 때 [!DNL staging] 업데이트 페이지에서 [!DNL Google Analytics Content Experiments] 오류를 수정합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/ko/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.27이 설치된 경우에 사용할 수 있습니다. 패치 ID는 ACSD-48634입니다. 이 문제는 Adobe Commerce 2.4.7에서 해결되었습니다.
...
[!DNL JS]을(를) 사용하도록 설정한 경우 [!DNL staging] 업데이트 페이지에서 [!DNL Google Analytics Content Experiments] 오류가 발생합니다.
...
1. **[!DNL Configure Google Analytics]** > **[!UICONTROL Stores]** > **[!UICONTROL Settings]** > **[!UICONTROL Configuration]** > **[!UICONTROL Sales]**(으)로 이동하여 **[!UICONTROL Google API]**&#x200B;을(를) 구성합니다.
   ...
   * **[!DNL Default Config]** [!DNL scope]의 경우:
      ...
      * **[!UICONTROL Anonymize IP]**: *[!UICONTROL Yes]*
      * **[!UICONTROL Enable Content Experiments]**: *[!UICONTROL Yes]*
1. **[!DNL Configure Google Analytics]**&#x200B;을(를) **[!DNL Default Config]**&#x200B;에서 [!DNL scope]&#x200B;(으)로 변경하여 **[!UICONTROL Enable]** *[!UICONTROL Yes]*&#x200B;에서 *[!UICONTROL No]*&#x200B;을(를) 사용하지 않도록 설정하십시오. 다른 것은 변경하지 않도록 주의하십시오!
