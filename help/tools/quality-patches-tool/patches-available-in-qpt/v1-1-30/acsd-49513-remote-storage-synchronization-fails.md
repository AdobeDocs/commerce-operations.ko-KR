...
ACSD-49513 패치는 0바이트 파일로 인해 원격 스토리지 동기화가 실패하는 문제를 해결합니다. 이 패치는 [[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.30이 설치되어 있을 때 사용할 수 있습니다. 패치 ID는 ACSD-49513입니다. 이 문제는 Adobe Commerce 2.4.7에서 수정됩니다.
