...
![컴퓨터에서 표가 빠짐](../../assets/playbooks/buyin.png)
...
![테이블 주위에 모인 그림](../../assets/playbooks/accountability.png)
...
![별 모양](../../assets/playbooks/c-level.png)
...
![그림 두 개](../../assets/playbooks/stakeholders.png)
...
정기적으로 비즈니스 사례 검토
- 문제 및 위험 에스컬레이션(문제 및 위험 에스컬레이션 지점)
위험 요소를 파악하고 비즈니스 사례와 관련된 모든 위험을 파악, 평가 및 제어해야 함)
...
디지털 성공 사례 연구 등 설명서 공유
구현을 통해 이 투자가 조직을 새로운 수준으로 이끄는 이유와 방법을 확인할 수 있습니다. 조직이 디지털 전환을 수용하려면 직원들에게 이를 알리는 것이 급선무입니다.
